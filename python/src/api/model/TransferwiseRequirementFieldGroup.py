...
from ..model.TransferwiseRequirementFieldGroupValidationAsync import TransferwiseRequirementFieldGroupValidationAsync
from ..model.TransferwiseRequirementFieldGroupValuesAllowed import TransferwiseRequirementFieldGroupValuesAllowed