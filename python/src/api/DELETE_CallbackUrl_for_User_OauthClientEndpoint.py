...
class DELETE_CallbackUrl_for_User_OauthClientEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, oauthclientID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self.path = DELETE_CallbackUrl_for_User_OauthClientEndpoint.Request.Path(userID = userID, oauthclientID = oauthclientID, itemId = itemId)
      self.queries = DELETE_CallbackUrl_for_User_OauthClientEndpoint.Request.Queries()
      self.headers = DELETE_CallbackUrl_for_User_OauthClientEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[OauthCallbackUrlDelete]):
    ...
    body: OauthCallbackUrlDelete = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: OauthCallbackUrlDelete):
      self.headers = DELETE_CallbackUrl_for_User_OauthClientEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[DELETE_CallbackUrl_for_User_OauthClient400ResponseBody]):
    ...
    body: DELETE_CallbackUrl_for_User_OauthClient400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: DELETE_CallbackUrl_for_User_OauthClient400ResponseBody):
      self.headers = DELETE_CallbackUrl_for_User_OauthClientEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def DELETE_CallbackUrl_for_User_OauthClient(self, req: Request) -> Response: pass
