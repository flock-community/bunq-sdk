...
class READ_NoteText_for_User_MonetaryAccount_PaymentEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, paymentID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self.path = READ_NoteText_for_User_MonetaryAccount_PaymentEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, paymentID = paymentID, itemId = itemId)
      self.queries = READ_NoteText_for_User_MonetaryAccount_PaymentEndpoint.Request.Queries()
      self.headers = READ_NoteText_for_User_MonetaryAccount_PaymentEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteTextPaymentRead]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteTextPaymentRead):
      self.headers = READ_NoteText_for_User_MonetaryAccount_PaymentEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[READ_NoteText_for_User_MonetaryAccount_Payment400ResponseBody]):
    ...
    body: READ_NoteText_for_User_MonetaryAccount_Payment400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: READ_NoteText_for_User_MonetaryAccount_Payment400ResponseBody):
      self.headers = READ_NoteText_for_User_MonetaryAccount_PaymentEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def READ_NoteText_for_User_MonetaryAccount_Payment(self, req: Request) -> Response: pass
