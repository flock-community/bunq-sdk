...
class CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransactionEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[NoteTextAdyenCardTransaction]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, adyencardtransactionID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteTextAdyenCardTransaction):
      self._path = CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransactionEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, adyencardtransactionID = adyencardtransactionID)
      self._queries = CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransactionEndpoint.Request.Queries()
      self._headers = CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransactionEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteTextAdyenCardTransactionCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteTextAdyenCardTransactionCreate):
      self._headers = CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransactionEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction400ResponseBody):
      self._headers = CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransactionEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction(self, req: 'CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransactionEndpoint.Request') -> 'CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransactionEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransactionEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransactionEndpoint.Request':
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransactionEndpoint.Response') -> Wirespec.RawResponse:
      match response:
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransactionEndpoint.Response':
