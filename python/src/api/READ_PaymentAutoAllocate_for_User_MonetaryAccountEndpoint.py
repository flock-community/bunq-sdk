...
class READ_PaymentAutoAllocate_for_User_MonetaryAccountEndpoint (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = READ_PaymentAutoAllocate_for_User_MonetaryAccountEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, itemId = itemId)
      self._queries = READ_PaymentAutoAllocate_for_User_MonetaryAccountEndpoint.Request.Queries()
      self._headers = READ_PaymentAutoAllocate_for_User_MonetaryAccountEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[PaymentAutoAllocateRead]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: PaymentAutoAllocateRead):
      self._headers = READ_PaymentAutoAllocate_for_User_MonetaryAccountEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[READ_PaymentAutoAllocate_for_User_MonetaryAccount400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: READ_PaymentAutoAllocate_for_User_MonetaryAccount400ResponseBody):
      self._headers = READ_PaymentAutoAllocate_for_User_MonetaryAccountEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def READ_PaymentAutoAllocate_for_User_MonetaryAccount(self, req: 'READ_PaymentAutoAllocate_for_User_MonetaryAccountEndpoint.Request') -> 'READ_PaymentAutoAllocate_for_User_MonetaryAccountEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'READ_PaymentAutoAllocate_for_User_MonetaryAccountEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'READ_PaymentAutoAllocate_for_User_MonetaryAccountEndpoint.Request':
      return READ_PaymentAutoAllocate_for_User_MonetaryAccountEndpoint.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'READ_PaymentAutoAllocate_for_User_MonetaryAccountEndpoint.Response') -> Wirespec.RawResponse:
      match response:
        case READ_PaymentAutoAllocate_for_User_MonetaryAccountEndpoint.Response200():
        ...
        case READ_PaymentAutoAllocate_for_User_MonetaryAccountEndpoint.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'READ_PaymentAutoAllocate_for_User_MonetaryAccountEndpoint.Response':
      match response.status_code:
        case 200:
          return READ_PaymentAutoAllocate_for_User_MonetaryAccountEndpoint.Response200(
        ...
        case 400:
          return READ_PaymentAutoAllocate_for_User_MonetaryAccountEndpoint.Response400(
