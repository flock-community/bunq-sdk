...
class CREATE_SessionServerEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[SessionServer]):
    ...
    def __init__(self, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: SessionServer):
      self.path = CREATE_SessionServerEndpoint.Request.Path()
      self.queries = CREATE_SessionServerEndpoint.Request.Queries()
      self.headers = CREATE_SessionServerEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[SessionServerCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: SessionServerCreate):
      self.headers = CREATE_SessionServerEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_SessionServer400ResponseBody]):
    ...
    body: CREATE_SessionServer400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_SessionServer400ResponseBody):
      self.headers = CREATE_SessionServerEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def CREATE_SessionServer(self, req: Request) -> Response: pass
