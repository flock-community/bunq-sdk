...
from ..model.TransferwiseAccountQuoteDelete import TransferwiseAccountQuoteDelete
from ..model.DELETE_TransferwiseRecipient_for_User_TransferwiseQuote400ResponseBody import DELETE_TransferwiseRecipient_for_User_TransferwiseQuote400ResponseBody

class DELETE_TransferwiseRecipient_for_User_TransferwiseQuote (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, transferwisequoteID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = DELETE_TransferwiseRecipient_for_User_TransferwiseQuote.Request.Path(userID = userID, transferwisequoteID = transferwisequoteID, itemId = itemId)
      self._queries =DELETE_TransferwiseRecipient_for_User_TransferwiseQuote.Request.Queries()
      self._headers = DELETE_TransferwiseRecipient_for_User_TransferwiseQuote.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[TransferwiseAccountQuoteDelete]):
    ...
    @property
    def body(self) -> TransferwiseAccountQuoteDelete:
      return self._body

    _body: TransferwiseAccountQuoteDelete
    _headers: Headers
    status: int = 200
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: TransferwiseAccountQuoteDelete):
      self._headers = DELETE_TransferwiseRecipient_for_User_TransferwiseQuote.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[DELETE_TransferwiseRecipient_for_User_TransferwiseQuote400ResponseBody]):
    ...
    @property
    def body(self) -> DELETE_TransferwiseRecipient_for_User_TransferwiseQuote400ResponseBody:
      return self._body

    _body: DELETE_TransferwiseRecipient_for_User_TransferwiseQuote400ResponseBody
    _headers: Headers
    status: int = 400
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: DELETE_TransferwiseRecipient_for_User_TransferwiseQuote400ResponseBody):
      self._headers = DELETE_TransferwiseRecipient_for_User_TransferwiseQuote.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def DELETE_TransferwiseRecipient_for_User_TransferwiseQuote(self, req: 'DELETE_TransferwiseRecipient_for_User_TransferwiseQuote.Request') -> 'DELETE_TransferwiseRecipient_for_User_TransferwiseQuote.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'DELETE_TransferwiseRecipient_for_User_TransferwiseQuote.Request') -> Wirespec.RawRequest:
      return Wirespec.RawRequest(
        path = ["user", str(request.path.userID), "transferwise-quote", str(request.path.transferwisequoteID), "transferwise-recipient", str(request.path.itemId)],
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'DELETE_TransferwiseRecipient_for_User_TransferwiseQuote.Request':
      return DELETE_TransferwiseRecipient_for_User_TransferwiseQuote.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'DELETE_TransferwiseRecipient_for_User_TransferwiseQuote.Response') -> Wirespec.RawResponse:
      match response:
        case DELETE_TransferwiseRecipient_for_User_TransferwiseQuote.Response200():
        ...
        case DELETE_TransferwiseRecipient_for_User_TransferwiseQuote.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'DELETE_TransferwiseRecipient_for_User_TransferwiseQuote.Response':
      match response.status_code:
        case 200:
          return DELETE_TransferwiseRecipient_for_User_TransferwiseQuote.Response200(
        ...
        case 400:
          return DELETE_TransferwiseRecipient_for_User_TransferwiseQuote.Response400(
