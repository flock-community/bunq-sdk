...
from ..model.SchedulePaymentCreate import SchedulePaymentCreate
from ..model.CREATE_SchedulePayment_for_User_MonetaryAccount400ResponseBody import CREATE_SchedulePayment_for_User_MonetaryAccount400ResponseBody

class CREATE_SchedulePayment_for_User_MonetaryAccount (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[SchedulePayment]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: SchedulePayment):
      self._path = CREATE_SchedulePayment_for_User_MonetaryAccount.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID)
      self._queries =CREATE_SchedulePayment_for_User_MonetaryAccount.Request.Queries()
      self._headers = CREATE_SchedulePayment_for_User_MonetaryAccount.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[SchedulePaymentCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: SchedulePaymentCreate):
      self._headers = CREATE_SchedulePayment_for_User_MonetaryAccount.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_SchedulePayment_for_User_MonetaryAccount400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_SchedulePayment_for_User_MonetaryAccount400ResponseBody):
      self._headers = CREATE_SchedulePayment_for_User_MonetaryAccount.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def CREATE_SchedulePayment_for_User_MonetaryAccount(self, req: 'CREATE_SchedulePayment_for_User_MonetaryAccount.Request') -> 'CREATE_SchedulePayment_for_User_MonetaryAccount.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'CREATE_SchedulePayment_for_User_MonetaryAccount.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'CREATE_SchedulePayment_for_User_MonetaryAccount.Request':
      return CREATE_SchedulePayment_for_User_MonetaryAccount.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'CREATE_SchedulePayment_for_User_MonetaryAccount.Response') -> Wirespec.RawResponse:
      match response:
        case CREATE_SchedulePayment_for_User_MonetaryAccount.Response200():
        ...
        case CREATE_SchedulePayment_for_User_MonetaryAccount.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'CREATE_SchedulePayment_for_User_MonetaryAccount.Response':
      match response.status_code:
        case 200:
          return CREATE_SchedulePayment_for_User_MonetaryAccount.Response200(
        ...
        case 400:
          return CREATE_SchedulePayment_for_User_MonetaryAccount.Response400(
