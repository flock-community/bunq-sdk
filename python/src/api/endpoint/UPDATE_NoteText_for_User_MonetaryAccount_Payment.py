...
from ..model.NoteTextPaymentUpdate import NoteTextPaymentUpdate
from ..model.UPDATE_NoteText_for_User_MonetaryAccount_Payment400ResponseBody import UPDATE_NoteText_for_User_MonetaryAccount_Payment400ResponseBody

class UPDATE_NoteText_for_User_MonetaryAccount_Payment (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[NoteTextPayment]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, paymentID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteTextPayment):
      self._path = UPDATE_NoteText_for_User_MonetaryAccount_Payment.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, paymentID = paymentID, itemId = itemId)
      self._queries =UPDATE_NoteText_for_User_MonetaryAccount_Payment.Request.Queries()
      self._headers = UPDATE_NoteText_for_User_MonetaryAccount_Payment.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteTextPaymentUpdate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteTextPaymentUpdate):
      self._headers = UPDATE_NoteText_for_User_MonetaryAccount_Payment.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_NoteText_for_User_MonetaryAccount_Payment400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_NoteText_for_User_MonetaryAccount_Payment400ResponseBody):
      self._headers = UPDATE_NoteText_for_User_MonetaryAccount_Payment.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def UPDATE_NoteText_for_User_MonetaryAccount_Payment(self, req: 'UPDATE_NoteText_for_User_MonetaryAccount_Payment.Request') -> 'UPDATE_NoteText_for_User_MonetaryAccount_Payment.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'UPDATE_NoteText_for_User_MonetaryAccount_Payment.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'UPDATE_NoteText_for_User_MonetaryAccount_Payment.Request':
      return UPDATE_NoteText_for_User_MonetaryAccount_Payment.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'UPDATE_NoteText_for_User_MonetaryAccount_Payment.Response') -> Wirespec.RawResponse:
      match response:
        case UPDATE_NoteText_for_User_MonetaryAccount_Payment.Response200():
        ...
        case UPDATE_NoteText_for_User_MonetaryAccount_Payment.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'UPDATE_NoteText_for_User_MonetaryAccount_Payment.Response':
      match response.status_code:
        case 200:
          return UPDATE_NoteText_for_User_MonetaryAccount_Payment.Response200(
        ...
        case 400:
          return UPDATE_NoteText_for_User_MonetaryAccount_Payment.Response400(
