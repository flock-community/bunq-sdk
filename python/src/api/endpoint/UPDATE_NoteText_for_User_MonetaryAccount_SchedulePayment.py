...
from ..model.NoteTextSchedulePayment import NoteTextSchedulePayment
from ..model.NoteTextSchedulePaymentUpdate import NoteTextSchedulePaymentUpdate
from ..model.UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment400ResponseBody import UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment400ResponseBody

class UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[NoteTextSchedulePayment]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, schedulepaymentID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteTextSchedulePayment):
      self._path = UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, schedulepaymentID = schedulepaymentID, itemId = itemId)
      self._queries =UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Request.Queries()
      self._headers = UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteTextSchedulePaymentUpdate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteTextSchedulePaymentUpdate):
      self._headers = UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment400ResponseBody):
      self._headers = UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment(self, req: 'UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Request') -> 'UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Request':
      return UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Response') -> Wirespec.RawResponse:
      match response:
        case UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Response200():
        ...
        case UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Response':
      match response.status_code:
        case 200:
          return UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Response200(
        ...
        case 400:
          return UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Response400(
