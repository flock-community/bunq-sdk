...
from ..model.NoteTextOpenBankingMerchantTransactionListing import NoteTextOpenBankingMerchantTransactionListing
from ..model.List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction400ResponseBody import List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction400ResponseBody

class List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, openbankingmerchanttransactionID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, openbankingmerchanttransactionID = openbankingmerchanttransactionID)
      self._queries =List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction.Request.Queries()
      self._headers = List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[List[NoteTextOpenBankingMerchantTransactionListing]]):
    ...
    @property
    def body(self) -> List[NoteTextOpenBankingMerchantTransactionListing]:
      return self._body

    _body: List[NoteTextOpenBankingMerchantTransactionListing]
    _headers: Headers
    status: int = 200
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List[NoteTextOpenBankingMerchantTransactionListing]):
      self._headers = List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction400ResponseBody]):
    ...
    @property
    def body(self) -> List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction400ResponseBody:
      return self._body

    _body: List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction400ResponseBody
    _headers: Headers
    status: int = 400
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction400ResponseBody):
      self._headers = List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction(self, req: 'List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction.Request') -> 'List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction.Request':
      return List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction.Response') -> Wirespec.RawResponse:
      match response:
        case List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction.Response200():
        ...
        case List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction.Response':
      match response.status_code:
        case 200:
          return List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction.Response200(
        ...
        case 400:
          return List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction.Response400(
