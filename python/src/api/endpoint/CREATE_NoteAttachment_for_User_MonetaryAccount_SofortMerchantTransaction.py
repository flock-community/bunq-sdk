...
from ..model.NoteAttachmentSofortMerchantTransaction import NoteAttachmentSofortMerchantTransaction
from ..model.NoteAttachmentSofortMerchantTransactionCreate import NoteAttachmentSofortMerchantTransactionCreate
from ..model.CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction400ResponseBody import CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction400ResponseBody

class CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[NoteAttachmentSofortMerchantTransaction]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, sofortmerchanttransactionID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteAttachmentSofortMerchantTransaction):
      self._path = CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, sofortmerchanttransactionID = sofortmerchanttransactionID)
      self._queries =CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction.Request.Queries()
      self._headers = CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteAttachmentSofortMerchantTransactionCreate]):
    ...
    @property
    def body(self) -> NoteAttachmentSofortMerchantTransactionCreate:
      return self._body

    _body: NoteAttachmentSofortMerchantTransactionCreate
    _headers: Headers
    status: int = 200
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteAttachmentSofortMerchantTransactionCreate):
      self._headers = CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction400ResponseBody]):
    ...
    @property
    def body(self) -> CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction400ResponseBody:
      return self._body

    _body: CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction400ResponseBody
    _headers: Headers
    status: int = 400
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction400ResponseBody):
      self._headers = CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction(self, req: 'CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction.Request') -> 'CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction.Request':
      return CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction.Response') -> Wirespec.RawResponse:
      match response:
        case CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction.Response200():
        ...
        case CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction.Response':
      match response.status_code:
        case 200:
          return CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction.Response200(
        ...
        case 400:
          return CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction.Response400(
