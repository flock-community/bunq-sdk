...
from ..model.AttachmentPublicRead import AttachmentPublicRead
from ..model.READ_AttachmentPublic400ResponseBody import READ_AttachmentPublic400ResponseBody

class READ_AttachmentPublic (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = READ_AttachmentPublic.Request.Path(itemId = itemId)
      self._queries =READ_AttachmentPublic.Request.Queries()
      self._headers = READ_AttachmentPublic.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[AttachmentPublicRead]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: AttachmentPublicRead):
      self._headers = READ_AttachmentPublic.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[READ_AttachmentPublic400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: READ_AttachmentPublic400ResponseBody):
      self._headers = READ_AttachmentPublic.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def READ_AttachmentPublic(self, req: 'READ_AttachmentPublic.Request') -> 'READ_AttachmentPublic.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'READ_AttachmentPublic.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'READ_AttachmentPublic.Request':
      return READ_AttachmentPublic.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'READ_AttachmentPublic.Response') -> Wirespec.RawResponse:
      match response:
        case READ_AttachmentPublic.Response200():
        ...
        case READ_AttachmentPublic.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'READ_AttachmentPublic.Response':
      match response.status_code:
        case 200:
          return READ_AttachmentPublic.Response200(
        ...
        case 400:
          return READ_AttachmentPublic.Response400(
