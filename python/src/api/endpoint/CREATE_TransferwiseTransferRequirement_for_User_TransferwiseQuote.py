...
from ..model.TransferwiseTransferRequirement import TransferwiseTransferRequirement
from ..model.TransferwiseTransferRequirementCreate import TransferwiseTransferRequirementCreate
from ..model.CREATE_TransferwiseTransferRequirement_for_User_TransferwiseQuote400ResponseBody import CREATE_TransferwiseTransferRequirement_for_User_TransferwiseQuote400ResponseBody

class CREATE_TransferwiseTransferRequirement_for_User_TransferwiseQuote (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[TransferwiseTransferRequirement]):
    ...
    def __init__(self, userID: int, transferwisequoteID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: TransferwiseTransferRequirement):
      self._path = CREATE_TransferwiseTransferRequirement_for_User_TransferwiseQuote.Request.Path(userID = userID, transferwisequoteID = transferwisequoteID)
      self._queries =CREATE_TransferwiseTransferRequirement_for_User_TransferwiseQuote.Request.Queries()
      self._headers = CREATE_TransferwiseTransferRequirement_for_User_TransferwiseQuote.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[TransferwiseTransferRequirementCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: TransferwiseTransferRequirementCreate):
      self._headers = CREATE_TransferwiseTransferRequirement_for_User_TransferwiseQuote.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_TransferwiseTransferRequirement_for_User_TransferwiseQuote400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_TransferwiseTransferRequirement_for_User_TransferwiseQuote400ResponseBody):
      self._headers = CREATE_TransferwiseTransferRequirement_for_User_TransferwiseQuote.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def CREATE_TransferwiseTransferRequirement_for_User_TransferwiseQuote(self, req: 'CREATE_TransferwiseTransferRequirement_for_User_TransferwiseQuote.Request') -> 'CREATE_TransferwiseTransferRequirement_for_User_TransferwiseQuote.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'CREATE_TransferwiseTransferRequirement_for_User_TransferwiseQuote.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'CREATE_TransferwiseTransferRequirement_for_User_TransferwiseQuote.Request':
      return CREATE_TransferwiseTransferRequirement_for_User_TransferwiseQuote.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'CREATE_TransferwiseTransferRequirement_for_User_TransferwiseQuote.Response') -> Wirespec.RawResponse:
      match response:
        case CREATE_TransferwiseTransferRequirement_for_User_TransferwiseQuote.Response200():
        ...
        case CREATE_TransferwiseTransferRequirement_for_User_TransferwiseQuote.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'CREATE_TransferwiseTransferRequirement_for_User_TransferwiseQuote.Response':
      match response.status_code:
        case 200:
          return CREATE_TransferwiseTransferRequirement_for_User_TransferwiseQuote.Response200(
        ...
        case 400:
          return CREATE_TransferwiseTransferRequirement_for_User_TransferwiseQuote.Response400(
