...
from ..model.NoteTextWhitelistResult import NoteTextWhitelistResult
from ..model.NoteTextWhitelistResultCreate import NoteTextWhitelistResultCreate
from ..model.CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult400ResponseBody import CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult400ResponseBody

class CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[NoteTextWhitelistResult]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, whitelistID: int, whitelistresultID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteTextWhitelistResult):
      self._path = CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, whitelistID = whitelistID, whitelistresultID = whitelistresultID)
      self._queries =CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult.Request.Queries()
      self._headers = CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteTextWhitelistResultCreate]):
    ...
    @property
    def body(self) -> NoteTextWhitelistResultCreate:
      return self._body

    _body: NoteTextWhitelistResultCreate
    _headers: Headers
    status: int = 200
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteTextWhitelistResultCreate):
      self._headers = CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult400ResponseBody]):
    ...
    @property
    def body(self) -> CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult400ResponseBody:
      return self._body

    _body: CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult400ResponseBody
    _headers: Headers
    status: int = 400
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult400ResponseBody):
      self._headers = CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult(self, req: 'CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult.Request') -> 'CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult.Request':
      return CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult.Response') -> Wirespec.RawResponse:
      match response:
        case CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult.Response200():
        ...
        case CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult.Response':
      match response.status_code:
        case 200:
          return CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult.Response200(
        ...
        case 400:
          return CREATE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult.Response400(
