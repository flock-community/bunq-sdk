...
from ..model.NoteAttachmentSchedulePaymentDelete import NoteAttachmentSchedulePaymentDelete
from ..model.DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment400ResponseBody import DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment400ResponseBody

class DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, schedulepaymentID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, schedulepaymentID = schedulepaymentID, itemId = itemId)
      self._queries =DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment.Request.Queries()
      self._headers = DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteAttachmentSchedulePaymentDelete]):
    ...
    @property
    def body(self) -> NoteAttachmentSchedulePaymentDelete:
      return self._body

    _body: NoteAttachmentSchedulePaymentDelete
    _headers: Headers
    status: int = 200
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteAttachmentSchedulePaymentDelete):
      self._headers = DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment400ResponseBody]):
    ...
    @property
    def body(self) -> DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment400ResponseBody:
      return self._body

    _body: DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment400ResponseBody
    _headers: Headers
    status: int = 400
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment400ResponseBody):
      self._headers = DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment(self, req: 'DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment.Request') -> 'DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment.Request':
      return DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment.Response') -> Wirespec.RawResponse:
      match response:
        case DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment.Response200():
        ...
        case DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment.Response':
      match response.status_code:
        case 200:
          return DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment.Response200(
        ...
        case 400:
          return DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment.Response400(
