...
from ..model.WhitelistSddOneOffUpdate import WhitelistSddOneOffUpdate
from ..model.UPDATE_WhitelistSddOneOff_for_User400ResponseBody import UPDATE_WhitelistSddOneOff_for_User400ResponseBody

class UPDATE_WhitelistSddOneOff_for_User (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[WhitelistSddOneOff]):
    ...
    def __init__(self, userID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: WhitelistSddOneOff):
      self._path = UPDATE_WhitelistSddOneOff_for_User.Request.Path(userID = userID, itemId = itemId)
      self._queries =UPDATE_WhitelistSddOneOff_for_User.Request.Queries()
      self._headers = UPDATE_WhitelistSddOneOff_for_User.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[WhitelistSddOneOffUpdate]):
    ...
    @property
    def body(self) -> WhitelistSddOneOffUpdate:
      return self._body

    _body: WhitelistSddOneOffUpdate
    _headers: Headers
    status: int = 200
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: WhitelistSddOneOffUpdate):
      self._headers = UPDATE_WhitelistSddOneOff_for_User.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_WhitelistSddOneOff_for_User400ResponseBody]):
    ...
    @property
    def body(self) -> UPDATE_WhitelistSddOneOff_for_User400ResponseBody:
      return self._body

    _body: UPDATE_WhitelistSddOneOff_for_User400ResponseBody
    _headers: Headers
    status: int = 400
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_WhitelistSddOneOff_for_User400ResponseBody):
      self._headers = UPDATE_WhitelistSddOneOff_for_User.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def UPDATE_WhitelistSddOneOff_for_User(self, req: 'UPDATE_WhitelistSddOneOff_for_User.Request') -> 'UPDATE_WhitelistSddOneOff_for_User.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'UPDATE_WhitelistSddOneOff_for_User.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'UPDATE_WhitelistSddOneOff_for_User.Request':
      return UPDATE_WhitelistSddOneOff_for_User.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'UPDATE_WhitelistSddOneOff_for_User.Response') -> Wirespec.RawResponse:
      match response:
        case UPDATE_WhitelistSddOneOff_for_User.Response200():
        ...
        case UPDATE_WhitelistSddOneOff_for_User.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'UPDATE_WhitelistSddOneOff_for_User.Response':
      match response.status_code:
        case 200:
          return UPDATE_WhitelistSddOneOff_for_User.Response200(
        ...
        case 400:
          return UPDATE_WhitelistSddOneOff_for_User.Response400(
