...
from ..model.NoteAttachmentScheduleRequest import NoteAttachmentScheduleRequest
from ..model.NoteAttachmentScheduleRequestUpdate import NoteAttachmentScheduleRequestUpdate
from ..model.UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry400ResponseBody import UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry400ResponseBody

class UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[NoteAttachmentScheduleRequest]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, schedulerequestinquiryID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteAttachmentScheduleRequest):
      self._path = UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, schedulerequestinquiryID = schedulerequestinquiryID, itemId = itemId)
      self._queries =UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Request.Queries()
      self._headers = UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteAttachmentScheduleRequestUpdate]):
    ...
    @property
    def body(self) -> NoteAttachmentScheduleRequestUpdate:
      return self._body

    _body: NoteAttachmentScheduleRequestUpdate
    _headers: Headers
    status: int = 200
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteAttachmentScheduleRequestUpdate):
      self._headers = UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry400ResponseBody]):
    ...
    @property
    def body(self) -> UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry400ResponseBody:
      return self._body

    _body: UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry400ResponseBody
    _headers: Headers
    status: int = 400
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry400ResponseBody):
      self._headers = UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry(self, req: 'UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Request') -> 'UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Request':
      return UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Response') -> Wirespec.RawResponse:
      match response:
        case UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Response200():
        ...
        case UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Response':
      match response.status_code:
        case 200:
          return UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Response200(
        ...
        case 400:
          return UPDATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Response400(
