...
from ..model.NoteTextDraftPayment import NoteTextDraftPayment
from ..model.NoteTextDraftPaymentCreate import NoteTextDraftPaymentCreate
from ..model.CREATE_NoteText_for_User_MonetaryAccount_DraftPayment400ResponseBody import CREATE_NoteText_for_User_MonetaryAccount_DraftPayment400ResponseBody

class CREATE_NoteText_for_User_MonetaryAccount_DraftPayment (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[NoteTextDraftPayment]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, draftpaymentID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteTextDraftPayment):
      self._path = CREATE_NoteText_for_User_MonetaryAccount_DraftPayment.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, draftpaymentID = draftpaymentID)
      self._queries =CREATE_NoteText_for_User_MonetaryAccount_DraftPayment.Request.Queries()
      self._headers = CREATE_NoteText_for_User_MonetaryAccount_DraftPayment.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteTextDraftPaymentCreate]):
    ...
    @property
    def body(self) -> NoteTextDraftPaymentCreate:
      return self._body

    _body: NoteTextDraftPaymentCreate
    _headers: Headers
    status: int = 200
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteTextDraftPaymentCreate):
      self._headers = CREATE_NoteText_for_User_MonetaryAccount_DraftPayment.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_NoteText_for_User_MonetaryAccount_DraftPayment400ResponseBody]):
    ...
    @property
    def body(self) -> CREATE_NoteText_for_User_MonetaryAccount_DraftPayment400ResponseBody:
      return self._body

    _body: CREATE_NoteText_for_User_MonetaryAccount_DraftPayment400ResponseBody
    _headers: Headers
    status: int = 400
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_NoteText_for_User_MonetaryAccount_DraftPayment400ResponseBody):
      self._headers = CREATE_NoteText_for_User_MonetaryAccount_DraftPayment.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def CREATE_NoteText_for_User_MonetaryAccount_DraftPayment(self, req: 'CREATE_NoteText_for_User_MonetaryAccount_DraftPayment.Request') -> 'CREATE_NoteText_for_User_MonetaryAccount_DraftPayment.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'CREATE_NoteText_for_User_MonetaryAccount_DraftPayment.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'CREATE_NoteText_for_User_MonetaryAccount_DraftPayment.Request':
      return CREATE_NoteText_for_User_MonetaryAccount_DraftPayment.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'CREATE_NoteText_for_User_MonetaryAccount_DraftPayment.Response') -> Wirespec.RawResponse:
      match response:
        case CREATE_NoteText_for_User_MonetaryAccount_DraftPayment.Response200():
        ...
        case CREATE_NoteText_for_User_MonetaryAccount_DraftPayment.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'CREATE_NoteText_for_User_MonetaryAccount_DraftPayment.Response':
      match response.status_code:
        case 200:
          return CREATE_NoteText_for_User_MonetaryAccount_DraftPayment.Response200(
        ...
        case 400:
          return CREATE_NoteText_for_User_MonetaryAccount_DraftPayment.Response400(
