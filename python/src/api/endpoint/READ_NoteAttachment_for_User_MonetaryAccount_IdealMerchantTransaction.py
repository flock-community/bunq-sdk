...
from ..model.NoteAttachmentIdealMerchantTransactionRead import NoteAttachmentIdealMerchantTransactionRead
from ..model.READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction400ResponseBody import READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction400ResponseBody

class READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, idealmerchanttransactionID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, idealmerchanttransactionID = idealmerchanttransactionID, itemId = itemId)
      self._queries =READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction.Request.Queries()
      self._headers = READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteAttachmentIdealMerchantTransactionRead]):
    ...
    @property
    def body(self) -> NoteAttachmentIdealMerchantTransactionRead:
      return self._body

    _body: NoteAttachmentIdealMerchantTransactionRead
    _headers: Headers
    status: int = 200
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteAttachmentIdealMerchantTransactionRead):
      self._headers = READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction400ResponseBody]):
    ...
    @property
    def body(self) -> READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction400ResponseBody:
      return self._body

    _body: READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction400ResponseBody
    _headers: Headers
    status: int = 400
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction400ResponseBody):
      self._headers = READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction(self, req: 'READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction.Request') -> 'READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction.Request':
      return READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction.Response') -> Wirespec.RawResponse:
      match response:
        case READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction.Response200():
        ...
        case READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction.Response':
      match response.status_code:
        case 200:
          return READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction.Response200(
        ...
        case 400:
          return READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction.Response400(
