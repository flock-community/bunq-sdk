...
from ..model.NoteTextAdyenCardTransactionCreate import NoteTextAdyenCardTransactionCreate
from ..model.CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction400ResponseBody import CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction400ResponseBody

class CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[NoteTextAdyenCardTransaction]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, adyencardtransactionID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteTextAdyenCardTransaction):
      self._path = CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, adyencardtransactionID = adyencardtransactionID)
      self._queries =CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Request.Queries()
      self._headers = CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteTextAdyenCardTransactionCreate]):
    ...
    @property
    def body(self) -> NoteTextAdyenCardTransactionCreate:
      return self._body

    _body: NoteTextAdyenCardTransactionCreate
    _headers: Headers
    status: int = 200
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteTextAdyenCardTransactionCreate):
      self._headers = CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction400ResponseBody]):
    ...
    @property
    def body(self) -> CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction400ResponseBody:
      return self._body

    _body: CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction400ResponseBody
    _headers: Headers
    status: int = 400
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction400ResponseBody):
      self._headers = CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction(self, req: 'CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Request') -> 'CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Request') -> Wirespec.RawRequest:
      return Wirespec.RawRequest(
        path = ["user", str(request.path.userID), "monetary-account", str(request.path.monetaryaccountID), "adyen-card-transaction", str(request.path.adyencardtransactionID), "note-text"],
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Request':
      return CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Response') -> Wirespec.RawResponse:
      match response:
        case CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Response200():
        ...
        case CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Response':
      match response.status_code:
        case 200:
          return CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Response200(
        ...
        case 400:
          return CREATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Response400(
