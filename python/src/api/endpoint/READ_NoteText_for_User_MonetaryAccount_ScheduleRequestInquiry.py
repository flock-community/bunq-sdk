...
from ..model.NoteTextScheduleRequestRead import NoteTextScheduleRequestRead
from ..model.READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry400ResponseBody import READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry400ResponseBody

class READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, schedulerequestinquiryID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, schedulerequestinquiryID = schedulerequestinquiryID, itemId = itemId)
      self._queries =READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry.Request.Queries()
      self._headers = READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteTextScheduleRequestRead]):
    ...
    @property
    def body(self) -> NoteTextScheduleRequestRead:
      return self._body

    _body: NoteTextScheduleRequestRead
    _headers: Headers
    status: int = 200
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteTextScheduleRequestRead):
      self._headers = READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry400ResponseBody]):
    ...
    @property
    def body(self) -> READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry400ResponseBody:
      return self._body

    _body: READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry400ResponseBody
    _headers: Headers
    status: int = 400
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry400ResponseBody):
      self._headers = READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry(self, req: 'READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry.Request') -> 'READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry.Request':
      return READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry.Response') -> Wirespec.RawResponse:
      match response:
        case READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry.Response200():
        ...
        case READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry.Response':
      match response.status_code:
        case 200:
          return READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry.Response200(
        ...
        case 400:
          return READ_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry.Response400(
