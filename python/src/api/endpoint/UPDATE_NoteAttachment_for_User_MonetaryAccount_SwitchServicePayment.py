...
from ..model.NoteAttachmentBankSwitchServiceNetherlandsIncomingPaymentUpdate import NoteAttachmentBankSwitchServiceNetherlandsIncomingPaymentUpdate
from ..model.UPDATE_NoteAttachment_for_User_MonetaryAccount_SwitchServicePayment400ResponseBody import UPDATE_NoteAttachment_for_User_MonetaryAccount_SwitchServicePayment400ResponseBody

class UPDATE_NoteAttachment_for_User_MonetaryAccount_SwitchServicePayment (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, switchservicepaymentID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteAttachmentBankSwitchServiceNetherlandsIncomingPayment):
      self._path = UPDATE_NoteAttachment_for_User_MonetaryAccount_SwitchServicePayment.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, switchservicepaymentID = switchservicepaymentID, itemId = itemId)
      self._queries =UPDATE_NoteAttachment_for_User_MonetaryAccount_SwitchServicePayment.Request.Queries()
      self._headers = UPDATE_NoteAttachment_for_User_MonetaryAccount_SwitchServicePayment.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteAttachmentBankSwitchServiceNetherlandsIncomingPaymentUpdate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteAttachmentBankSwitchServiceNetherlandsIncomingPaymentUpdate):
      self._headers = UPDATE_NoteAttachment_for_User_MonetaryAccount_SwitchServicePayment.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_NoteAttachment_for_User_MonetaryAccount_SwitchServicePayment400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_NoteAttachment_for_User_MonetaryAccount_SwitchServicePayment400ResponseBody):
      self._headers = UPDATE_NoteAttachment_for_User_MonetaryAccount_SwitchServicePayment.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def UPDATE_NoteAttachment_for_User_MonetaryAccount_SwitchServicePayment(self, req: 'UPDATE_NoteAttachment_for_User_MonetaryAccount_SwitchServicePayment.Request') -> 'UPDATE_NoteAttachment_for_User_MonetaryAccount_SwitchServicePayment.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'UPDATE_NoteAttachment_for_User_MonetaryAccount_SwitchServicePayment.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'UPDATE_NoteAttachment_for_User_MonetaryAccount_SwitchServicePayment.Request':
      return UPDATE_NoteAttachment_for_User_MonetaryAccount_SwitchServicePayment.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'UPDATE_NoteAttachment_for_User_MonetaryAccount_SwitchServicePayment.Response') -> Wirespec.RawResponse:
      match response:
        case UPDATE_NoteAttachment_for_User_MonetaryAccount_SwitchServicePayment.Response200():
        ...
        case UPDATE_NoteAttachment_for_User_MonetaryAccount_SwitchServicePayment.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'UPDATE_NoteAttachment_for_User_MonetaryAccount_SwitchServicePayment.Response':
      match response.status_code:
        case 200:
          return UPDATE_NoteAttachment_for_User_MonetaryAccount_SwitchServicePayment.Response200(
        ...
        case 400:
          return UPDATE_NoteAttachment_for_User_MonetaryAccount_SwitchServicePayment.Response400(
