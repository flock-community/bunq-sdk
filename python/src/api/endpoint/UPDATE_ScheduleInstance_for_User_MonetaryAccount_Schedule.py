...
from ..model.ScheduleInstanceUpdate import ScheduleInstanceUpdate
from ..model.UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule400ResponseBody import UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule400ResponseBody

class UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[ScheduleInstance]):
    ...
    @property
    def body(self) -> ScheduleInstance:
      return self._body
    ...
    def __init__(self, userID: int, monetaryaccountID: int, scheduleID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: ScheduleInstance):
      self._path = UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, scheduleID = scheduleID, itemId = itemId)
      self._queries =UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule.Request.Queries()
      self._headers = UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[ScheduleInstanceUpdate]):
    ...
    @property
    def body(self) -> ScheduleInstanceUpdate:
      return self._body

    _body: ScheduleInstanceUpdate
    _headers: Headers
    status: int = 200
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: ScheduleInstanceUpdate):
      self._headers = UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule400ResponseBody]):
    ...
    @property
    def body(self) -> UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule400ResponseBody:
      return self._body

    _body: UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule400ResponseBody
    _headers: Headers
    status: int = 400
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule400ResponseBody):
      self._headers = UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule(self, req: 'UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule.Request') -> 'UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule.Request':
      return UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule.Response') -> Wirespec.RawResponse:
      match response:
        case UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule.Response200():
        ...
        case UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule.Response':
      match response.status_code:
        case 200:
          return UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule.Response200(
        ...
        case 400:
          return UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule.Response400(
