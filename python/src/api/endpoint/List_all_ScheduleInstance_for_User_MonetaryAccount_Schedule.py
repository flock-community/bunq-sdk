...
from ..model.ScheduleInstanceListing import ScheduleInstanceListing
from ..model.List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule400ResponseBody import List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule400ResponseBody

class List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, scheduleID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, scheduleID = scheduleID)
      self._queries =List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule.Request.Queries()
      self._headers = List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[List[ScheduleInstanceListing]]):
    ...
    @property
    def body(self) -> List[ScheduleInstanceListing]:
      return self._body

    _body: List[ScheduleInstanceListing]
    _headers: Headers
    status: int = 200
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List[ScheduleInstanceListing]):
      self._headers = List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule400ResponseBody]):
    ...
    @property
    def body(self) -> List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule400ResponseBody:
      return self._body

    _body: List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule400ResponseBody
    _headers: Headers
    status: int = 400
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule400ResponseBody):
      self._headers = List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule(self, req: 'List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule.Request') -> 'List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule.Request') -> Wirespec.RawRequest:
      return Wirespec.RawRequest(
        path = ["user", str(request.path.userID), "monetary-account", str(request.path.monetaryaccountID), "schedule", str(request.path.scheduleID), "schedule-instance"],
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule.Request':
      return List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule.Response') -> Wirespec.RawResponse:
      match response:
        case List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule.Response200():
        ...
        case List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule.Response':
      match response.status_code:
        case 200:
          return List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule.Response200(
        ...
        case 400:
          return List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule.Response400(
