...
from ..model.OauthCallbackUrlRead import OauthCallbackUrlRead
from ..model.READ_CallbackUrl_for_User_OauthClient400ResponseBody import READ_CallbackUrl_for_User_OauthClient400ResponseBody

class READ_CallbackUrl_for_User_OauthClient (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, oauthclientID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = READ_CallbackUrl_for_User_OauthClient.Request.Path(userID = userID, oauthclientID = oauthclientID, itemId = itemId)
      self._queries =READ_CallbackUrl_for_User_OauthClient.Request.Queries()
      self._headers = READ_CallbackUrl_for_User_OauthClient.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[OauthCallbackUrlRead]):
    ...
    @property
    def body(self) -> OauthCallbackUrlRead:
      return self._body

    _body: OauthCallbackUrlRead
    _headers: Headers
    status: int = 200
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: OauthCallbackUrlRead):
      self._headers = READ_CallbackUrl_for_User_OauthClient.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[READ_CallbackUrl_for_User_OauthClient400ResponseBody]):
    ...
    @property
    def body(self) -> READ_CallbackUrl_for_User_OauthClient400ResponseBody:
      return self._body

    _body: READ_CallbackUrl_for_User_OauthClient400ResponseBody
    _headers: Headers
    status: int = 400
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: READ_CallbackUrl_for_User_OauthClient400ResponseBody):
      self._headers = READ_CallbackUrl_for_User_OauthClient.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def READ_CallbackUrl_for_User_OauthClient(self, req: 'READ_CallbackUrl_for_User_OauthClient.Request') -> 'READ_CallbackUrl_for_User_OauthClient.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'READ_CallbackUrl_for_User_OauthClient.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'READ_CallbackUrl_for_User_OauthClient.Request':
      return READ_CallbackUrl_for_User_OauthClient.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'READ_CallbackUrl_for_User_OauthClient.Response') -> Wirespec.RawResponse:
      match response:
        case READ_CallbackUrl_for_User_OauthClient.Response200():
        ...
        case READ_CallbackUrl_for_User_OauthClient.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'READ_CallbackUrl_for_User_OauthClient.Response':
      match response.status_code:
        case 200:
          return READ_CallbackUrl_for_User_OauthClient.Response200(
        ...
        case 400:
          return READ_CallbackUrl_for_User_OauthClient.Response400(
