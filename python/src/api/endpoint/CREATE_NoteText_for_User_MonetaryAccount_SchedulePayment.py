...
from ..model.NoteTextSchedulePaymentCreate import NoteTextSchedulePaymentCreate
from ..model.CREATE_NoteText_for_User_MonetaryAccount_SchedulePayment400ResponseBody import CREATE_NoteText_for_User_MonetaryAccount_SchedulePayment400ResponseBody

class CREATE_NoteText_for_User_MonetaryAccount_SchedulePayment (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[NoteTextSchedulePayment]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, schedulepaymentID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteTextSchedulePayment):
      self._path = CREATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, schedulepaymentID = schedulepaymentID)
      self._queries =CREATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Request.Queries()
      self._headers = CREATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteTextSchedulePaymentCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteTextSchedulePaymentCreate):
      self._headers = CREATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_NoteText_for_User_MonetaryAccount_SchedulePayment400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_NoteText_for_User_MonetaryAccount_SchedulePayment400ResponseBody):
      self._headers = CREATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def CREATE_NoteText_for_User_MonetaryAccount_SchedulePayment(self, req: 'CREATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Request') -> 'CREATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'CREATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'CREATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Request':
      return CREATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'CREATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Response') -> Wirespec.RawResponse:
      match response:
        case CREATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Response200():
        ...
        case CREATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'CREATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Response':
      match response.status_code:
        case 200:
          return CREATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Response200(
        ...
        case 400:
          return CREATE_NoteText_for_User_MonetaryAccount_SchedulePayment.Response400(
