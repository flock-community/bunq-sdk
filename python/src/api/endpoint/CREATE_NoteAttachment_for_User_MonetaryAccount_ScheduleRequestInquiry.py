...
from ..model.NoteAttachmentScheduleRequestCreate import NoteAttachmentScheduleRequestCreate
from ..model.CREATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry400ResponseBody import CREATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry400ResponseBody

class CREATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[NoteAttachmentScheduleRequest]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, schedulerequestinquiryID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteAttachmentScheduleRequest):
      self._path = CREATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, schedulerequestinquiryID = schedulerequestinquiryID)
      self._queries =CREATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Request.Queries()
      self._headers = CREATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteAttachmentScheduleRequestCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteAttachmentScheduleRequestCreate):
      self._headers = CREATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry400ResponseBody):
      self._headers = CREATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def CREATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry(self, req: 'CREATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Request') -> 'CREATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'CREATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'CREATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Request':
      return CREATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'CREATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Response') -> Wirespec.RawResponse:
      match response:
        case CREATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Response200():
        ...
        case CREATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'CREATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Response':
      match response.status_code:
        case 200:
          return CREATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Response200(
        ...
        case 400:
          return CREATE_NoteAttachment_for_User_MonetaryAccount_ScheduleRequestInquiry.Response400(
