...
from ..model.NoteAttachmentRequestInquiryBatchUpdate import NoteAttachmentRequestInquiryBatchUpdate
from ..model.UPDATE_NoteAttachment_for_User_MonetaryAccount_RequestInquiryBatch400ResponseBody import UPDATE_NoteAttachment_for_User_MonetaryAccount_RequestInquiryBatch400ResponseBody

class UPDATE_NoteAttachment_for_User_MonetaryAccount_RequestInquiryBatch (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[NoteAttachmentRequestInquiryBatch]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, requestinquirybatchID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteAttachmentRequestInquiryBatch):
      self._path = UPDATE_NoteAttachment_for_User_MonetaryAccount_RequestInquiryBatch.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, requestinquirybatchID = requestinquirybatchID, itemId = itemId)
      self._queries =UPDATE_NoteAttachment_for_User_MonetaryAccount_RequestInquiryBatch.Request.Queries()
      self._headers = UPDATE_NoteAttachment_for_User_MonetaryAccount_RequestInquiryBatch.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteAttachmentRequestInquiryBatchUpdate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteAttachmentRequestInquiryBatchUpdate):
      self._headers = UPDATE_NoteAttachment_for_User_MonetaryAccount_RequestInquiryBatch.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_NoteAttachment_for_User_MonetaryAccount_RequestInquiryBatch400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_NoteAttachment_for_User_MonetaryAccount_RequestInquiryBatch400ResponseBody):
      self._headers = UPDATE_NoteAttachment_for_User_MonetaryAccount_RequestInquiryBatch.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def UPDATE_NoteAttachment_for_User_MonetaryAccount_RequestInquiryBatch(self, req: 'UPDATE_NoteAttachment_for_User_MonetaryAccount_RequestInquiryBatch.Request') -> 'UPDATE_NoteAttachment_for_User_MonetaryAccount_RequestInquiryBatch.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'UPDATE_NoteAttachment_for_User_MonetaryAccount_RequestInquiryBatch.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'UPDATE_NoteAttachment_for_User_MonetaryAccount_RequestInquiryBatch.Request':
      return UPDATE_NoteAttachment_for_User_MonetaryAccount_RequestInquiryBatch.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'UPDATE_NoteAttachment_for_User_MonetaryAccount_RequestInquiryBatch.Response') -> Wirespec.RawResponse:
      match response:
        case UPDATE_NoteAttachment_for_User_MonetaryAccount_RequestInquiryBatch.Response200():
        ...
        case UPDATE_NoteAttachment_for_User_MonetaryAccount_RequestInquiryBatch.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'UPDATE_NoteAttachment_for_User_MonetaryAccount_RequestInquiryBatch.Response':
      match response.status_code:
        case 200:
          return UPDATE_NoteAttachment_for_User_MonetaryAccount_RequestInquiryBatch.Response200(
        ...
        case 400:
          return UPDATE_NoteAttachment_for_User_MonetaryAccount_RequestInquiryBatch.Response400(
