...
from ..model.ExportStatementPayment import ExportStatementPayment
from ..model.ExportStatementPaymentCreate import ExportStatementPaymentCreate
from ..model.CREATE_Statement_for_User_MonetaryAccount_Event400ResponseBody import CREATE_Statement_for_User_MonetaryAccount_Event400ResponseBody

class CREATE_Statement_for_User_MonetaryAccount_Event (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[ExportStatementPayment]):
    ...
    @property
    def body(self) -> ExportStatementPayment:
      return self._body
    ...
    def __init__(self, userID: int, monetaryaccountID: int, eventID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: ExportStatementPayment):
      self._path = CREATE_Statement_for_User_MonetaryAccount_Event.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, eventID = eventID)
      self._queries =CREATE_Statement_for_User_MonetaryAccount_Event.Request.Queries()
      self._headers = CREATE_Statement_for_User_MonetaryAccount_Event.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[ExportStatementPaymentCreate]):
    ...
    @property
    def body(self) -> ExportStatementPaymentCreate:
      return self._body

    _body: ExportStatementPaymentCreate
    _headers: Headers
    status: int = 200
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: ExportStatementPaymentCreate):
      self._headers = CREATE_Statement_for_User_MonetaryAccount_Event.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_Statement_for_User_MonetaryAccount_Event400ResponseBody]):
    ...
    @property
    def body(self) -> CREATE_Statement_for_User_MonetaryAccount_Event400ResponseBody:
      return self._body

    _body: CREATE_Statement_for_User_MonetaryAccount_Event400ResponseBody
    _headers: Headers
    status: int = 400
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_Statement_for_User_MonetaryAccount_Event400ResponseBody):
      self._headers = CREATE_Statement_for_User_MonetaryAccount_Event.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def CREATE_Statement_for_User_MonetaryAccount_Event(self, req: 'CREATE_Statement_for_User_MonetaryAccount_Event.Request') -> 'CREATE_Statement_for_User_MonetaryAccount_Event.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'CREATE_Statement_for_User_MonetaryAccount_Event.Request') -> Wirespec.RawRequest:
      return Wirespec.RawRequest(
        path = ["user", str(request.path.userID), "monetary-account", str(request.path.monetaryaccountID), "event", str(request.path.eventID), "statement"],
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'CREATE_Statement_for_User_MonetaryAccount_Event.Request':
      return CREATE_Statement_for_User_MonetaryAccount_Event.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'CREATE_Statement_for_User_MonetaryAccount_Event.Response') -> Wirespec.RawResponse:
      match response:
        case CREATE_Statement_for_User_MonetaryAccount_Event.Response200():
        ...
        case CREATE_Statement_for_User_MonetaryAccount_Event.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'CREATE_Statement_for_User_MonetaryAccount_Event.Response':
      match response.status_code:
        case 200:
          return CREATE_Statement_for_User_MonetaryAccount_Event.Response200(
        ...
        case 400:
          return CREATE_Statement_for_User_MonetaryAccount_Event.Response400(
