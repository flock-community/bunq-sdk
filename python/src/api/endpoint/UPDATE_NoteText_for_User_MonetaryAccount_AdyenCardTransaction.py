...
from ..model.NoteTextAdyenCardTransaction import NoteTextAdyenCardTransaction
from ..model.NoteTextAdyenCardTransactionUpdate import NoteTextAdyenCardTransactionUpdate
from ..model.UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction400ResponseBody import UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction400ResponseBody

class UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[NoteTextAdyenCardTransaction]):
    ...
    @property
    def body(self) -> NoteTextAdyenCardTransaction:
      return self._body
    ...
    _body:  NoteTextAdyenCardTransaction
    _headers: Headers
    _queries: Queries
    _path: Path
    ...
    def __init__(self, userID: int, monetaryaccountID: int, adyencardtransactionID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteTextAdyenCardTransaction):
      self._path = UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, adyencardtransactionID = adyencardtransactionID, itemId = itemId)
      self._queries =UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Request.Queries()
      self._headers = UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteTextAdyenCardTransactionUpdate]):
    ...
    @property
    def body(self) -> NoteTextAdyenCardTransactionUpdate:
      return self._body

    _body: NoteTextAdyenCardTransactionUpdate
    _headers: Headers
    status: int = 200
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteTextAdyenCardTransactionUpdate):
      self._headers = UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction400ResponseBody]):
    ...
    @property
    def body(self) -> UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction400ResponseBody:
      return self._body

    _body: UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction400ResponseBody
    _headers: Headers
    status: int = 400
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction400ResponseBody):
      self._headers = UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction(self, req: 'UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Request') -> 'UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Request':
      return UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Response') -> Wirespec.RawResponse:
      match response:
        case UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Response200():
        ...
        case UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Response':
      match response.status_code:
        case 200:
          return UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Response200(
        ...
        case 400:
          return UPDATE_NoteText_for_User_MonetaryAccount_AdyenCardTransaction.Response400(
