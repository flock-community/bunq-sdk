...
from ..model.CardGeneratedCvc2Listing import CardGeneratedCvc2Listing
from ..model.List_all_GeneratedCvc2_for_User_Card400ResponseBody import List_all_GeneratedCvc2_for_User_Card400ResponseBody

class List_all_GeneratedCvc2_for_User_Card (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, cardID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = List_all_GeneratedCvc2_for_User_Card.Request.Path(userID = userID, cardID = cardID)
      self._queries =List_all_GeneratedCvc2_for_User_Card.Request.Queries()
      self._headers = List_all_GeneratedCvc2_for_User_Card.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[List[CardGeneratedCvc2Listing]]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List[CardGeneratedCvc2Listing]):
      self._headers = List_all_GeneratedCvc2_for_User_Card.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[List_all_GeneratedCvc2_for_User_Card400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List_all_GeneratedCvc2_for_User_Card400ResponseBody):
      self._headers = List_all_GeneratedCvc2_for_User_Card.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def List_all_GeneratedCvc2_for_User_Card(self, req: 'List_all_GeneratedCvc2_for_User_Card.Request') -> 'List_all_GeneratedCvc2_for_User_Card.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'List_all_GeneratedCvc2_for_User_Card.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'List_all_GeneratedCvc2_for_User_Card.Request':
      return List_all_GeneratedCvc2_for_User_Card.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'List_all_GeneratedCvc2_for_User_Card.Response') -> Wirespec.RawResponse:
      match response:
        case List_all_GeneratedCvc2_for_User_Card.Response200():
        ...
        case List_all_GeneratedCvc2_for_User_Card.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'List_all_GeneratedCvc2_for_User_Card.Response':
      match response.status_code:
        case 200:
          return List_all_GeneratedCvc2_for_User_Card.Response200(
        ...
        case 400:
          return List_all_GeneratedCvc2_for_User_Card.Response400(
