...
from ..model.NoteAttachmentPaymentCreate import NoteAttachmentPaymentCreate
from ..model.CREATE_NoteAttachment_for_User_MonetaryAccount_Payment400ResponseBody import CREATE_NoteAttachment_for_User_MonetaryAccount_Payment400ResponseBody

class CREATE_NoteAttachment_for_User_MonetaryAccount_Payment (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[NoteAttachmentPayment]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, paymentID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteAttachmentPayment):
      self._path = CREATE_NoteAttachment_for_User_MonetaryAccount_Payment.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, paymentID = paymentID)
      self._queries =CREATE_NoteAttachment_for_User_MonetaryAccount_Payment.Request.Queries()
      self._headers = CREATE_NoteAttachment_for_User_MonetaryAccount_Payment.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteAttachmentPaymentCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteAttachmentPaymentCreate):
      self._headers = CREATE_NoteAttachment_for_User_MonetaryAccount_Payment.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_NoteAttachment_for_User_MonetaryAccount_Payment400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_NoteAttachment_for_User_MonetaryAccount_Payment400ResponseBody):
      self._headers = CREATE_NoteAttachment_for_User_MonetaryAccount_Payment.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def CREATE_NoteAttachment_for_User_MonetaryAccount_Payment(self, req: 'CREATE_NoteAttachment_for_User_MonetaryAccount_Payment.Request') -> 'CREATE_NoteAttachment_for_User_MonetaryAccount_Payment.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'CREATE_NoteAttachment_for_User_MonetaryAccount_Payment.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'CREATE_NoteAttachment_for_User_MonetaryAccount_Payment.Request':
      return CREATE_NoteAttachment_for_User_MonetaryAccount_Payment.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'CREATE_NoteAttachment_for_User_MonetaryAccount_Payment.Response') -> Wirespec.RawResponse:
      match response:
        case CREATE_NoteAttachment_for_User_MonetaryAccount_Payment.Response200():
        ...
        case CREATE_NoteAttachment_for_User_MonetaryAccount_Payment.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'CREATE_NoteAttachment_for_User_MonetaryAccount_Payment.Response':
      match response.status_code:
        case 200:
          return CREATE_NoteAttachment_for_User_MonetaryAccount_Payment.Response200(
        ...
        case 400:
          return CREATE_NoteAttachment_for_User_MonetaryAccount_Payment.Response400(
