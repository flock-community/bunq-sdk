...
from ..model.PermittedIpUpdate import PermittedIpUpdate
from ..model.UPDATE_Ip_for_User_CredentialPasswordIp400ResponseBody import UPDATE_Ip_for_User_CredentialPasswordIp400ResponseBody

class UPDATE_Ip_for_User_CredentialPasswordIp (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[PermittedIp]):
    ...
    def __init__(self, userID: int, credentialpasswordipID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: PermittedIp):
      self._path = UPDATE_Ip_for_User_CredentialPasswordIp.Request.Path(userID = userID, credentialpasswordipID = credentialpasswordipID, itemId = itemId)
      self._queries =UPDATE_Ip_for_User_CredentialPasswordIp.Request.Queries()
      self._headers = UPDATE_Ip_for_User_CredentialPasswordIp.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[PermittedIpUpdate]):
    ...
    @property
    def body(self) -> PermittedIpUpdate:
      return self._body

    _body: PermittedIpUpdate
    _headers: Headers
    status: int = 200
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: PermittedIpUpdate):
      self._headers = UPDATE_Ip_for_User_CredentialPasswordIp.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_Ip_for_User_CredentialPasswordIp400ResponseBody]):
    ...
    @property
    def body(self) -> UPDATE_Ip_for_User_CredentialPasswordIp400ResponseBody:
      return self._body

    _body: UPDATE_Ip_for_User_CredentialPasswordIp400ResponseBody
    _headers: Headers
    status: int = 400
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_Ip_for_User_CredentialPasswordIp400ResponseBody):
      self._headers = UPDATE_Ip_for_User_CredentialPasswordIp.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def UPDATE_Ip_for_User_CredentialPasswordIp(self, req: 'UPDATE_Ip_for_User_CredentialPasswordIp.Request') -> 'UPDATE_Ip_for_User_CredentialPasswordIp.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'UPDATE_Ip_for_User_CredentialPasswordIp.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'UPDATE_Ip_for_User_CredentialPasswordIp.Request':
      return UPDATE_Ip_for_User_CredentialPasswordIp.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'UPDATE_Ip_for_User_CredentialPasswordIp.Response') -> Wirespec.RawResponse:
      match response:
        case UPDATE_Ip_for_User_CredentialPasswordIp.Response200():
        ...
        case UPDATE_Ip_for_User_CredentialPasswordIp.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'UPDATE_Ip_for_User_CredentialPasswordIp.Response':
      match response.status_code:
        case 200:
          return UPDATE_Ip_for_User_CredentialPasswordIp.Response200(
        ...
        case 400:
          return UPDATE_Ip_for_User_CredentialPasswordIp.Response400(
