...
from ..model.SandboxUserPerson import SandboxUserPerson
from ..model.SandboxUserPersonCreate import SandboxUserPersonCreate
from ..model.CREATE_SandboxUserPerson400ResponseBody import CREATE_SandboxUserPerson400ResponseBody

class CREATE_SandboxUserPerson (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[SandboxUserPerson]):
    ...
    @property
    def body(self) -> SandboxUserPerson:
      return self._body
    ...
    def __init__(self, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: SandboxUserPerson):
      self._path = CREATE_SandboxUserPerson.Request.Path()
      self._queries =CREATE_SandboxUserPerson.Request.Queries()
      self._headers = CREATE_SandboxUserPerson.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[SandboxUserPersonCreate]):
    ...
    @property
    def body(self) -> SandboxUserPersonCreate:
      return self._body

    _body: SandboxUserPersonCreate
    _headers: Headers
    status: int = 200
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: SandboxUserPersonCreate):
      self._headers = CREATE_SandboxUserPerson.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_SandboxUserPerson400ResponseBody]):
    ...
    @property
    def body(self) -> CREATE_SandboxUserPerson400ResponseBody:
      return self._body

    _body: CREATE_SandboxUserPerson400ResponseBody
    _headers: Headers
    status: int = 400
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_SandboxUserPerson400ResponseBody):
      self._headers = CREATE_SandboxUserPerson.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def CREATE_SandboxUserPerson(self, req: 'CREATE_SandboxUserPerson.Request') -> 'CREATE_SandboxUserPerson.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'CREATE_SandboxUserPerson.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'CREATE_SandboxUserPerson.Request':
      return CREATE_SandboxUserPerson.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'CREATE_SandboxUserPerson.Response') -> Wirespec.RawResponse:
      match response:
        case CREATE_SandboxUserPerson.Response200():
        ...
        case CREATE_SandboxUserPerson.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'CREATE_SandboxUserPerson.Response':
      match response.status_code:
        case 200:
          return CREATE_SandboxUserPerson.Response200(
        ...
        case 400:
          return CREATE_SandboxUserPerson.Response400(
