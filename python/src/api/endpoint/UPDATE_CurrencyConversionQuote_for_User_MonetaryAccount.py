...
from ..model.CurrencyConversionQuoteUpdate import CurrencyConversionQuoteUpdate
from ..model.UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount400ResponseBody import UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount400ResponseBody

class UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[CurrencyConversionQuote]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: CurrencyConversionQuote):
      self._path = UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, itemId = itemId)
      self._queries =UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount.Request.Queries()
      self._headers = UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[CurrencyConversionQuoteUpdate]):
    ...
    @property
    def body(self) -> CurrencyConversionQuoteUpdate:
      return self._body

    _body: CurrencyConversionQuoteUpdate
    _headers: Headers
    status: int = 200
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CurrencyConversionQuoteUpdate):
      self._headers = UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount400ResponseBody]):
    ...
    @property
    def body(self) -> UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount400ResponseBody:
      return self._body

    _body: UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount400ResponseBody
    _headers: Headers
    status: int = 400
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount400ResponseBody):
      self._headers = UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount(self, req: 'UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount.Request') -> 'UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount.Request':
      return UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount.Response') -> Wirespec.RawResponse:
      match response:
        case UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount.Response200():
        ...
        case UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount.Response':
      match response.status_code:
        case 200:
          return UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount.Response200(
        ...
        case 400:
          return UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount.Response400(
