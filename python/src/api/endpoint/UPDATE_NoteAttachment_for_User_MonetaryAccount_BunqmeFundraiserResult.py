...
from ..model.NoteAttachmentBunqMeFundraiserResultUpdate import NoteAttachmentBunqMeFundraiserResultUpdate
from ..model.UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult400ResponseBody import UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult400ResponseBody

class UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[NoteAttachmentBunqMeFundraiserResult]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, bunqmefundraiserresultID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteAttachmentBunqMeFundraiserResult):
      self._path = UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, bunqmefundraiserresultID = bunqmefundraiserresultID, itemId = itemId)
      self._queries =UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult.Request.Queries()
      self._headers = UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteAttachmentBunqMeFundraiserResultUpdate]):
    ...
    @property
    def body(self) -> NoteAttachmentBunqMeFundraiserResultUpdate:
      return self._body

    _body: NoteAttachmentBunqMeFundraiserResultUpdate
    _headers: Headers
    status: int = 200
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteAttachmentBunqMeFundraiserResultUpdate):
      self._headers = UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult400ResponseBody]):
    ...
    @property
    def body(self) -> UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult400ResponseBody:
      return self._body

    _body: UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult400ResponseBody
    _headers: Headers
    status: int = 400
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult400ResponseBody):
      self._headers = UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult(self, req: 'UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult.Request') -> 'UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult.Request':
      return UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult.Response') -> Wirespec.RawResponse:
      match response:
        case UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult.Response200():
        ...
        case UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult.Response':
      match response.status_code:
        case 200:
          return UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult.Response200(
        ...
        case 400:
          return UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult.Response400(
