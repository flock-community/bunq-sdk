...
class DELETE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, whitelistID: int, whitelistresultID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self.path = DELETE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, whitelistID = whitelistID, whitelistresultID = whitelistresultID, itemId = itemId)
      self.queries = DELETE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint.Request.Queries()
      self.headers = DELETE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  def to_raw_request(serialization: Wirespec.Serializer, request: Request) -> Wirespec.RawRequest:
    return Wirespec.RawRequest(
      path = ["user", str(request.path.userID), "monetary-account", str(request.path.monetary-accountID), "whitelist", str(request.path.whitelistID), "whitelist-result", str(request.path.whitelist-resultID), "note-text", str(request.path.itemId)],
  ...
  class Response200(Wirespec.Response[NoteTextWhitelistResultDelete]):
    ...
    body: NoteTextWhitelistResultDelete = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteTextWhitelistResultDelete):
      self.headers = DELETE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[DELETE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult400ResponseBody]):
    ...
    body: DELETE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: DELETE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult400ResponseBody):
      self.headers = DELETE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def DELETE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult(self, req: Request) -> Response: pass
