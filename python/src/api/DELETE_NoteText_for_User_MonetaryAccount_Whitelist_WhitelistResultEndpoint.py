...
class DELETE_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint (Wirespec.Endpoint):
  ...
  def to_raw_request(serialization: Wirespec.Serializer, request: Request) -> Wirespec.RawRequest:
    return Wirespec.RawRequest(
      path = ["user", request.path.userID, "monetary-account", request.path.monetary-accountID, "whitelist", request.path.whitelistID, "whitelist-result", request.path.whitelist-resultID, "note-text", request.path.itemId],
