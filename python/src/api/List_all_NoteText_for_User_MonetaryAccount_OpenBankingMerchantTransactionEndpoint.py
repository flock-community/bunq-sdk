...
class List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransactionEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, openbankingmerchanttransactionID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransactionEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, openbankingmerchanttransactionID = openbankingmerchanttransactionID)
      self._queries = List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransactionEndpoint.Request.Queries()
      self._headers = List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransactionEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[List[NoteTextOpenBankingMerchantTransactionListing]]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List[NoteTextOpenBankingMerchantTransactionListing]):
      self._headers = List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransactionEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction400ResponseBody):
      self._headers = List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransactionEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction(self, req: 'List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransactionEndpoint.Request') -> 'List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransactionEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransactionEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransactionEndpoint.Request':
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransactionEndpoint.Response') -> Wirespec.RawResponse:
      match response:
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'List_all_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransactionEndpoint.Response':
