...
class List_all_Name_for_UserCompanyEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, usercompanyID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self.path = List_all_Name_for_UserCompanyEndpoint.Request.Path(usercompanyID = usercompanyID)
      self.queries = List_all_Name_for_UserCompanyEndpoint.Request.Queries()
      self.headers = List_all_Name_for_UserCompanyEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  def to_raw_request(serialization: Wirespec.Serializer, request: Request) -> Wirespec.RawRequest:
    return Wirespec.RawRequest(
      path = ["user-company", str(request.path.user-companyID), "name"],
  ...
  class Response200(Wirespec.Response[List[UserCompanyNameListing]]):
    ...
    body: List[UserCompanyNameListing] = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List[UserCompanyNameListing]):
      self.headers = List_all_Name_for_UserCompanyEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[List_all_Name_for_UserCompany400ResponseBody]):
    ...
    body: List_all_Name_for_UserCompany400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List_all_Name_for_UserCompany400ResponseBody):
      self.headers = List_all_Name_for_UserCompanyEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def List_all_Name_for_UserCompany(self, req: Request) -> Response: pass
