...
class DELETE_InvoiceExport_for_User_InvoiceEndpoint (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, invoiceID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = DELETE_InvoiceExport_for_User_InvoiceEndpoint.Request.Path(userID = userID, invoiceID = invoiceID, itemId = itemId)
      self._queries = DELETE_InvoiceExport_for_User_InvoiceEndpoint.Request.Queries()
      self._headers = DELETE_InvoiceExport_for_User_InvoiceEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[InvoiceExportPdfDelete]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: InvoiceExportPdfDelete):
      self._headers = DELETE_InvoiceExport_for_User_InvoiceEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[DELETE_InvoiceExport_for_User_Invoice400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: DELETE_InvoiceExport_for_User_Invoice400ResponseBody):
      self._headers = DELETE_InvoiceExport_for_User_InvoiceEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def DELETE_InvoiceExport_for_User_Invoice(self, req: 'DELETE_InvoiceExport_for_User_InvoiceEndpoint.Request') -> 'DELETE_InvoiceExport_for_User_InvoiceEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'DELETE_InvoiceExport_for_User_InvoiceEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'DELETE_InvoiceExport_for_User_InvoiceEndpoint.Request':
      return DELETE_InvoiceExport_for_User_InvoiceEndpoint.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'DELETE_InvoiceExport_for_User_InvoiceEndpoint.Response') -> Wirespec.RawResponse:
      match response:
        case DELETE_InvoiceExport_for_User_InvoiceEndpoint.Response200():
        ...
        case DELETE_InvoiceExport_for_User_InvoiceEndpoint.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'DELETE_InvoiceExport_for_User_InvoiceEndpoint.Response':
      match response.status_code:
        case 200:
          return DELETE_InvoiceExport_for_User_InvoiceEndpoint.Response200(
        ...
        case 400:
          return DELETE_InvoiceExport_for_User_InvoiceEndpoint.Response400(
