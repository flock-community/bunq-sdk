...
class CREATE_Statement_for_User_MonetaryAccount_EventEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[ExportStatementPayment]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, eventID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: ExportStatementPayment):
      self._path = CREATE_Statement_for_User_MonetaryAccount_EventEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, eventID = eventID)
      self._queries = CREATE_Statement_for_User_MonetaryAccount_EventEndpoint.Request.Queries()
      self._headers = CREATE_Statement_for_User_MonetaryAccount_EventEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[ExportStatementPaymentCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: ExportStatementPaymentCreate):
      self._headers = CREATE_Statement_for_User_MonetaryAccount_EventEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_Statement_for_User_MonetaryAccount_Event400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_Statement_for_User_MonetaryAccount_Event400ResponseBody):
      self._headers = CREATE_Statement_for_User_MonetaryAccount_EventEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def CREATE_Statement_for_User_MonetaryAccount_Event(self, req: 'CREATE_Statement_for_User_MonetaryAccount_EventEndpoint.Request') -> 'CREATE_Statement_for_User_MonetaryAccount_EventEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'CREATE_Statement_for_User_MonetaryAccount_EventEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'CREATE_Statement_for_User_MonetaryAccount_EventEndpoint.Request':
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'CREATE_Statement_for_User_MonetaryAccount_EventEndpoint.Response') -> Wirespec.RawResponse:
      match response:
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'CREATE_Statement_for_User_MonetaryAccount_EventEndpoint.Response':
