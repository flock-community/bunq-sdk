...
class UPDATE_WhitelistSddOneOff_for_UserEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[WhitelistSddOneOff]):
    ...
    def __init__(self, userID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: WhitelistSddOneOff):
      self._path = UPDATE_WhitelistSddOneOff_for_UserEndpoint.Request.Path(userID = userID, itemId = itemId)
      self._queries = UPDATE_WhitelistSddOneOff_for_UserEndpoint.Request.Queries()
      self._headers = UPDATE_WhitelistSddOneOff_for_UserEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[WhitelistSddOneOffUpdate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: WhitelistSddOneOffUpdate):
      self._headers = UPDATE_WhitelistSddOneOff_for_UserEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_WhitelistSddOneOff_for_User400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_WhitelistSddOneOff_for_User400ResponseBody):
      self._headers = UPDATE_WhitelistSddOneOff_for_UserEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def UPDATE_WhitelistSddOneOff_for_User(self, req: 'UPDATE_WhitelistSddOneOff_for_UserEndpoint.Request') -> 'UPDATE_WhitelistSddOneOff_for_UserEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'UPDATE_WhitelistSddOneOff_for_UserEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'UPDATE_WhitelistSddOneOff_for_UserEndpoint.Request':
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'UPDATE_WhitelistSddOneOff_for_UserEndpoint.Response') -> Wirespec.RawResponse:
      match response:
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'UPDATE_WhitelistSddOneOff_for_UserEndpoint.Response':
