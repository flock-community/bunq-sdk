...
class CREATE_CurrencyCloudPaymentQuote_for_User_MonetaryAccountEndpoint (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[CurrencyCloudPaymentQuote]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: CurrencyCloudPaymentQuote):
      self._path = CREATE_CurrencyCloudPaymentQuote_for_User_MonetaryAccountEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID)
      self._queries = CREATE_CurrencyCloudPaymentQuote_for_User_MonetaryAccountEndpoint.Request.Queries()
      self._headers = CREATE_CurrencyCloudPaymentQuote_for_User_MonetaryAccountEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[CurrencyCloudPaymentQuoteCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CurrencyCloudPaymentQuoteCreate):
      self._headers = CREATE_CurrencyCloudPaymentQuote_for_User_MonetaryAccountEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_CurrencyCloudPaymentQuote_for_User_MonetaryAccount400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_CurrencyCloudPaymentQuote_for_User_MonetaryAccount400ResponseBody):
      self._headers = CREATE_CurrencyCloudPaymentQuote_for_User_MonetaryAccountEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def CREATE_CurrencyCloudPaymentQuote_for_User_MonetaryAccount(self, req: 'CREATE_CurrencyCloudPaymentQuote_for_User_MonetaryAccountEndpoint.Request') -> 'CREATE_CurrencyCloudPaymentQuote_for_User_MonetaryAccountEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'CREATE_CurrencyCloudPaymentQuote_for_User_MonetaryAccountEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'CREATE_CurrencyCloudPaymentQuote_for_User_MonetaryAccountEndpoint.Request':
      return CREATE_CurrencyCloudPaymentQuote_for_User_MonetaryAccountEndpoint.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'CREATE_CurrencyCloudPaymentQuote_for_User_MonetaryAccountEndpoint.Response') -> Wirespec.RawResponse:
      match response:
        case CREATE_CurrencyCloudPaymentQuote_for_User_MonetaryAccountEndpoint.Response200():
        ...
        case CREATE_CurrencyCloudPaymentQuote_for_User_MonetaryAccountEndpoint.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'CREATE_CurrencyCloudPaymentQuote_for_User_MonetaryAccountEndpoint.Response':
      match response.status_code:
        case 200:
          return CREATE_CurrencyCloudPaymentQuote_for_User_MonetaryAccountEndpoint.Response200(
        ...
        case 400:
          return CREATE_CurrencyCloudPaymentQuote_for_User_MonetaryAccountEndpoint.Response400(
