...
class CREATE_DeviceServerEndpoint (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[DeviceServer]):
    ...
    def __init__(self, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: DeviceServer):
      self._path = CREATE_DeviceServerEndpoint.Request.Path()
      self._queries = CREATE_DeviceServerEndpoint.Request.Queries()
      self._headers = CREATE_DeviceServerEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[DeviceServerCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: DeviceServerCreate):
      self._headers = CREATE_DeviceServerEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_DeviceServer400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_DeviceServer400ResponseBody):
      self._headers = CREATE_DeviceServerEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def CREATE_DeviceServer(self, req: 'CREATE_DeviceServerEndpoint.Request') -> 'CREATE_DeviceServerEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'CREATE_DeviceServerEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'CREATE_DeviceServerEndpoint.Request':
      return CREATE_DeviceServerEndpoint.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'CREATE_DeviceServerEndpoint.Response') -> Wirespec.RawResponse:
      match response:
        case CREATE_DeviceServerEndpoint.Response200():
        ...
        case CREATE_DeviceServerEndpoint.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'CREATE_DeviceServerEndpoint.Response':
      match response.status_code:
        case 200:
          return CREATE_DeviceServerEndpoint.Response200(
        ...
        case 400:
          return CREATE_DeviceServerEndpoint.Response400(
