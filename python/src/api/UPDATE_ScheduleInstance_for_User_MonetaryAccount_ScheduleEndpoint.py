...
class UPDATE_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[ScheduleInstance]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, scheduleID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: ScheduleInstance):
      self._path = UPDATE_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, scheduleID = scheduleID, itemId = itemId)
      self._queries = UPDATE_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint.Request.Queries()
      self._headers = UPDATE_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[ScheduleInstanceUpdate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: ScheduleInstanceUpdate):
      self._headers = UPDATE_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule400ResponseBody):
      self._headers = UPDATE_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def UPDATE_ScheduleInstance_for_User_MonetaryAccount_Schedule(self, req: 'UPDATE_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint.Request') -> 'UPDATE_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'UPDATE_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'UPDATE_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint.Request':
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'UPDATE_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint.Response') -> Wirespec.RawResponse:
      match response:
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'UPDATE_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint.Response':
