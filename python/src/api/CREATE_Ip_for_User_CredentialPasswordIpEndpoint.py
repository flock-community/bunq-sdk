...
class CREATE_Ip_for_User_CredentialPasswordIpEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[PermittedIp]):
    ...
    def __init__(self, userID: int, credentialpasswordipID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: PermittedIp):
      self.path = CREATE_Ip_for_User_CredentialPasswordIpEndpoint.Request.Path(userID = userID, credentialpasswordipID = credentialpasswordipID)
      self.queries = CREATE_Ip_for_User_CredentialPasswordIpEndpoint.Request.Queries()
      self.headers = CREATE_Ip_for_User_CredentialPasswordIpEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[PermittedIpCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: PermittedIpCreate):
      self.headers = CREATE_Ip_for_User_CredentialPasswordIpEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_Ip_for_User_CredentialPasswordIp400ResponseBody]):
    ...
    body: CREATE_Ip_for_User_CredentialPasswordIp400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_Ip_for_User_CredentialPasswordIp400ResponseBody):
      self.headers = CREATE_Ip_for_User_CredentialPasswordIpEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def CREATE_Ip_for_User_CredentialPasswordIp(self, req: Request) -> Response: pass
