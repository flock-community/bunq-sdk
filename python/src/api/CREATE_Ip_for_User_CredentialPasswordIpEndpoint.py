...
class CREATE_Ip_for_User_CredentialPasswordIpEndpoint (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[PermittedIp]):
    ...
    def __init__(self, userID: int, credentialpasswordipID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: PermittedIp):
      self._path = CREATE_Ip_for_User_CredentialPasswordIpEndpoint.Request.Path(userID = userID, credentialpasswordipID = credentialpasswordipID)
      self._queries = CREATE_Ip_for_User_CredentialPasswordIpEndpoint.Request.Queries()
      self._headers = CREATE_Ip_for_User_CredentialPasswordIpEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[PermittedIpCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: PermittedIpCreate):
      self._headers = CREATE_Ip_for_User_CredentialPasswordIpEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_Ip_for_User_CredentialPasswordIp400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_Ip_for_User_CredentialPasswordIp400ResponseBody):
      self._headers = CREATE_Ip_for_User_CredentialPasswordIpEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def CREATE_Ip_for_User_CredentialPasswordIp(self, req: 'CREATE_Ip_for_User_CredentialPasswordIpEndpoint.Request') -> 'CREATE_Ip_for_User_CredentialPasswordIpEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'CREATE_Ip_for_User_CredentialPasswordIpEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'CREATE_Ip_for_User_CredentialPasswordIpEndpoint.Request':
      return CREATE_Ip_for_User_CredentialPasswordIpEndpoint.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'CREATE_Ip_for_User_CredentialPasswordIpEndpoint.Response') -> Wirespec.RawResponse:
      match response:
        case CREATE_Ip_for_User_CredentialPasswordIpEndpoint.Response200():
        ...
        case CREATE_Ip_for_User_CredentialPasswordIpEndpoint.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'CREATE_Ip_for_User_CredentialPasswordIpEndpoint.Response':
      match response.status_code:
        case 200:
          return CREATE_Ip_for_User_CredentialPasswordIpEndpoint.Response200(
        ...
        case 400:
          return CREATE_Ip_for_User_CredentialPasswordIpEndpoint.Response400(
