...
class READ_UserCompanyEndpoint (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = READ_UserCompanyEndpoint.Request.Path(itemId = itemId)
      self._queries = READ_UserCompanyEndpoint.Request.Queries()
      self._headers = READ_UserCompanyEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  @dataclass
  class Response200(Wirespec.Response[UserCompanyRead]):
    @dataclass
    ...
    @property
    def body(self) -> UserCompanyRead:
      return self._body

    _body: UserCompanyRead
    _headers: Headers
    status: int = 200

    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UserCompanyRead):
      self._headers = READ_UserCompanyEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body

  @dataclass
  class Response400(Wirespec.Response[READ_UserCompany400ResponseBody]):
    @dataclass
    class Headers (Wirespec.Response.Headers):
        XBunqClientResponseId: 'Optional[str]'
        XBunqClientRequestId: 'Optional[str]'
    ...
    @property
    def body(self) -> READ_UserCompany400ResponseBody:
      return self._body

    _body: READ_UserCompany400ResponseBody
    _headers: Headers
    status: int = 400

    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: READ_UserCompany400ResponseBody):
      self._headers = READ_UserCompanyEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def READ_UserCompany(self, req: 'READ_UserCompanyEndpoint.Request') -> 'READ_UserCompanyEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'READ_UserCompanyEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'READ_UserCompanyEndpoint.Request':
      return READ_UserCompanyEndpoint.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'READ_UserCompanyEndpoint.Response') -> Wirespec.RawResponse:
      match response:
        case READ_UserCompanyEndpoint.Response200():
          return Wirespec.RawResponse(
            ...
            body = serialization.serialize(response.body, UserCompanyRead),
          )
        case READ_UserCompanyEndpoint.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
            body = serialization.serialize(response.body, READ_UserCompany400ResponseBody),
          )
        case _:
          raise Exception("Cannot match response with status: " + str(response.status))
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'READ_UserCompanyEndpoint.Response':
      match response.status_code:
        case 200:
          return READ_UserCompanyEndpoint.Response200(
            body = serialization.deserialize(response.body, UserCompanyRead),
        ...
        case 400:
          return READ_UserCompanyEndpoint.Response400(
            body = serialization.deserialize(response.body, READ_UserCompany400ResponseBody),
            XBunqClientResponseId = serialization.deserialize_param(response.headers.get("X-Bunq-Client-Response-Id".lower()), str),
            XBunqClientRequestId = serialization.deserialize_param(response.headers.get("X-Bunq-Client-Request-Id".lower()), str),
            XBunqServerSignature = serialization.deserialize_param(response.headers.get("X-Bunq-Server-Signature".lower()), str)
          )
