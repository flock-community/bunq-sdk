...
class DELETE_NoteText_for_User_MonetaryAccount_IdealMerchantTransactionEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, idealmerchanttransactionID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self.path = DELETE_NoteText_for_User_MonetaryAccount_IdealMerchantTransactionEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, idealmerchanttransactionID = idealmerchanttransactionID, itemId = itemId)
      self.queries = DELETE_NoteText_for_User_MonetaryAccount_IdealMerchantTransactionEndpoint.Request.Queries()
      self.headers = DELETE_NoteText_for_User_MonetaryAccount_IdealMerchantTransactionEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteTextIdealMerchantTransactionDelete]):
    ...
    body: NoteTextIdealMerchantTransactionDelete = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteTextIdealMerchantTransactionDelete):
      self.headers = DELETE_NoteText_for_User_MonetaryAccount_IdealMerchantTransactionEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[DELETE_NoteText_for_User_MonetaryAccount_IdealMerchantTransaction400ResponseBody]):
    ...
    body: DELETE_NoteText_for_User_MonetaryAccount_IdealMerchantTransaction400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: DELETE_NoteText_for_User_MonetaryAccount_IdealMerchantTransaction400ResponseBody):
      self.headers = DELETE_NoteText_for_User_MonetaryAccount_IdealMerchantTransactionEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def DELETE_NoteText_for_User_MonetaryAccount_IdealMerchantTransaction(self, req: Request) -> Response: pass
