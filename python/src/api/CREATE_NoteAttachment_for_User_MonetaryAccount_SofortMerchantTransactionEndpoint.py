...
class CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransactionEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[NoteAttachmentSofortMerchantTransaction]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, sofortmerchanttransactionID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteAttachmentSofortMerchantTransaction):
      self._path = CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransactionEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, sofortmerchanttransactionID = sofortmerchanttransactionID)
      self._queries = CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransactionEndpoint.Request.Queries()
      self._headers = CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransactionEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteAttachmentSofortMerchantTransactionCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteAttachmentSofortMerchantTransactionCreate):
      self._headers = CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransactionEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction400ResponseBody):
      self._headers = CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransactionEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransaction(self, req: 'CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransactionEndpoint.Request') -> 'CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransactionEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransactionEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransactionEndpoint.Request':
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransactionEndpoint.Response') -> Wirespec.RawResponse:
      match response:
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'CREATE_NoteAttachment_for_User_MonetaryAccount_SofortMerchantTransactionEndpoint.Response':
