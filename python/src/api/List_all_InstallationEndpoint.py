...
class List_all_InstallationEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self.path = List_all_InstallationEndpoint.Request.Path()
      self.queries = List_all_InstallationEndpoint.Request.Queries()
      self.headers = List_all_InstallationEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[List[InstallationListing]]):
    ...
    body: List[InstallationListing] = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List[InstallationListing]):
      self.headers = List_all_InstallationEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[List_all_Installation400ResponseBody]):
    ...
    body: List_all_Installation400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List_all_Installation400ResponseBody):
      self.headers = List_all_InstallationEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def List_all_Installation(self, req: Request) -> Response: pass
