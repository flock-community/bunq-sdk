...
class UPDATE_GeneratedCvc2_for_User_CardEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[CardGeneratedCvc2]):
    ...
    def __init__(self, userID: int, cardID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: CardGeneratedCvc2):
      self._path = UPDATE_GeneratedCvc2_for_User_CardEndpoint.Request.Path(userID = userID, cardID = cardID, itemId = itemId)
      self._queries = UPDATE_GeneratedCvc2_for_User_CardEndpoint.Request.Queries()
      self._headers = UPDATE_GeneratedCvc2_for_User_CardEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[CardGeneratedCvc2Update]):
    ...
    @property
    def body(self) -> CardGeneratedCvc2Update:
      return self._body

    _body: CardGeneratedCvc2Update
    _headers: Headers
    status: int = 200
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CardGeneratedCvc2Update):
      self._headers = UPDATE_GeneratedCvc2_for_User_CardEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_GeneratedCvc2_for_User_Card400ResponseBody]):
    ...
    @property
    def body(self) -> UPDATE_GeneratedCvc2_for_User_Card400ResponseBody:
      return self._body

    _body: UPDATE_GeneratedCvc2_for_User_Card400ResponseBody
    _headers: Headers
    status: int = 400
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_GeneratedCvc2_for_User_Card400ResponseBody):
      self._headers = UPDATE_GeneratedCvc2_for_User_CardEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def UPDATE_GeneratedCvc2_for_User_Card(self, req: 'UPDATE_GeneratedCvc2_for_User_CardEndpoint.Request') -> 'UPDATE_GeneratedCvc2_for_User_CardEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'UPDATE_GeneratedCvc2_for_User_CardEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'UPDATE_GeneratedCvc2_for_User_CardEndpoint.Request':
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'UPDATE_GeneratedCvc2_for_User_CardEndpoint.Response') -> Wirespec.RawResponse:
      match response:
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'UPDATE_GeneratedCvc2_for_User_CardEndpoint.Response':
