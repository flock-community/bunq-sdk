...
class CREATE_CardBatch_for_UserEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[CardBatch]):
    ...
    def __init__(self, userID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: CardBatch):
      self.path = CREATE_CardBatch_for_UserEndpoint.Request.Path(userID = userID)
      self.queries = CREATE_CardBatch_for_UserEndpoint.Request.Queries()
      self.headers = CREATE_CardBatch_for_UserEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[CardBatchCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CardBatchCreate):
      self.headers = CREATE_CardBatch_for_UserEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_CardBatch_for_User400ResponseBody]):
    ...
    body: CREATE_CardBatch_for_User400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_CardBatch_for_User400ResponseBody):
      self.headers = CREATE_CardBatch_for_UserEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def CREATE_CardBatch_for_User(self, req: Request) -> Response: pass
