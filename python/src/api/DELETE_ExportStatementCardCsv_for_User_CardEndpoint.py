...
class DELETE_ExportStatementCardCsv_for_User_CardEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, cardID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self.path = DELETE_ExportStatementCardCsv_for_User_CardEndpoint.Request.Path(userID = userID, cardID = cardID, itemId = itemId)
      self.queries = DELETE_ExportStatementCardCsv_for_User_CardEndpoint.Request.Queries()
      self.headers = DELETE_ExportStatementCardCsv_for_User_CardEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[ExportStatementCardCsvDelete]):
    ...
    body: ExportStatementCardCsvDelete = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: ExportStatementCardCsvDelete):
      self.headers = DELETE_ExportStatementCardCsv_for_User_CardEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[DELETE_ExportStatementCardCsv_for_User_Card400ResponseBody]):
    ...
    body: DELETE_ExportStatementCardCsv_for_User_Card400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: DELETE_ExportStatementCardCsv_for_User_Card400ResponseBody):
      self.headers = DELETE_ExportStatementCardCsv_for_User_CardEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def DELETE_ExportStatementCardCsv_for_User_Card(self, req: Request) -> Response: pass
