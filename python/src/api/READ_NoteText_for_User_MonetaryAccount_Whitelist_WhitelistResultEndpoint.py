...
class READ_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, whitelistID: int, whitelistresultID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self.path = READ_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, whitelistID = whitelistID, whitelistresultID = whitelistresultID, itemId = itemId)
      self.queries = READ_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint.Request.Queries()
      self.headers = READ_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteTextWhitelistResultRead]):
    ...
    body: NoteTextWhitelistResultRead = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteTextWhitelistResultRead):
      self.headers = READ_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[READ_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult400ResponseBody]):
    ...
    body: READ_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: READ_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult400ResponseBody):
      self.headers = READ_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def READ_NoteText_for_User_MonetaryAccount_Whitelist_WhitelistResult(self, req: Request) -> Response: pass
