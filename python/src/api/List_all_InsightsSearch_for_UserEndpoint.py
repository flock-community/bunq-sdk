...
class List_all_InsightsSearch_for_UserEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self.path = List_all_InsightsSearch_for_UserEndpoint.Request.Path(userID = userID)
      self.queries = List_all_InsightsSearch_for_UserEndpoint.Request.Queries()
      self.headers = List_all_InsightsSearch_for_UserEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[List[InsightEventListing]]):
    ...
    body: List[InsightEventListing] = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List[InsightEventListing]):
      self.headers = List_all_InsightsSearch_for_UserEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[List_all_InsightsSearch_for_User400ResponseBody]):
    ...
    body: List_all_InsightsSearch_for_User400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List_all_InsightsSearch_for_User400ResponseBody):
      self.headers = List_all_InsightsSearch_for_UserEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def List_all_InsightsSearch_for_User(self, req: Request) -> Response: pass
