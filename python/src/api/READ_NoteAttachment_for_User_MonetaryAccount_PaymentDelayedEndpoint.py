...
class READ_NoteAttachment_for_User_MonetaryAccount_PaymentDelayedEndpoint (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, paymentdelayedID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = READ_NoteAttachment_for_User_MonetaryAccount_PaymentDelayedEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, paymentdelayedID = paymentdelayedID, itemId = itemId)
      self._queries = READ_NoteAttachment_for_User_MonetaryAccount_PaymentDelayedEndpoint.Request.Queries()
      self._headers = READ_NoteAttachment_for_User_MonetaryAccount_PaymentDelayedEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteAttachmentPaymentDelayedRead]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteAttachmentPaymentDelayedRead):
      self._headers = READ_NoteAttachment_for_User_MonetaryAccount_PaymentDelayedEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[READ_NoteAttachment_for_User_MonetaryAccount_PaymentDelayed400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: READ_NoteAttachment_for_User_MonetaryAccount_PaymentDelayed400ResponseBody):
      self._headers = READ_NoteAttachment_for_User_MonetaryAccount_PaymentDelayedEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def READ_NoteAttachment_for_User_MonetaryAccount_PaymentDelayed(self, req: 'READ_NoteAttachment_for_User_MonetaryAccount_PaymentDelayedEndpoint.Request') -> 'READ_NoteAttachment_for_User_MonetaryAccount_PaymentDelayedEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'READ_NoteAttachment_for_User_MonetaryAccount_PaymentDelayedEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'READ_NoteAttachment_for_User_MonetaryAccount_PaymentDelayedEndpoint.Request':
      return READ_NoteAttachment_for_User_MonetaryAccount_PaymentDelayedEndpoint.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'READ_NoteAttachment_for_User_MonetaryAccount_PaymentDelayedEndpoint.Response') -> Wirespec.RawResponse:
      match response:
        case READ_NoteAttachment_for_User_MonetaryAccount_PaymentDelayedEndpoint.Response200():
        ...
        case READ_NoteAttachment_for_User_MonetaryAccount_PaymentDelayedEndpoint.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'READ_NoteAttachment_for_User_MonetaryAccount_PaymentDelayedEndpoint.Response':
      match response.status_code:
        case 200:
          return READ_NoteAttachment_for_User_MonetaryAccount_PaymentDelayedEndpoint.Response200(
        ...
        case 400:
          return READ_NoteAttachment_for_User_MonetaryAccount_PaymentDelayedEndpoint.Response400(
