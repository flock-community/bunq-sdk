...
class READ_Ip_for_User_CredentialPasswordIpEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, credentialpasswordipID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self.path = READ_Ip_for_User_CredentialPasswordIpEndpoint.Request.Path(userID = userID, credentialpasswordipID = credentialpasswordipID, itemId = itemId)
      self.queries = READ_Ip_for_User_CredentialPasswordIpEndpoint.Request.Queries()
      self.headers = READ_Ip_for_User_CredentialPasswordIpEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  def to_raw_request(serialization: Wirespec.Serializer, request: Request) -> Wirespec.RawRequest:
    return Wirespec.RawRequest(
      path = ["user", request.path.userID, "credential-password-ip", request.path.credential-password-ipID, "ip", request.path.itemId],
  ...
  class Response200(Wirespec.Response[PermittedIpRead]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: PermittedIpRead):
      self.headers = READ_Ip_for_User_CredentialPasswordIpEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[READ_Ip_for_User_CredentialPasswordIp400ResponseBody]):
    ...
    body: READ_Ip_for_User_CredentialPasswordIp400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: READ_Ip_for_User_CredentialPasswordIp400ResponseBody):
      self.headers = READ_Ip_for_User_CredentialPasswordIpEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def READ_Ip_for_User_CredentialPasswordIp(self, req: Request) -> Response: pass
