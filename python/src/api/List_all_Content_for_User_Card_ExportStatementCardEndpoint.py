...
class List_all_Content_for_User_Card_ExportStatementCardEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, cardID: int, exportstatementcardID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self.path = List_all_Content_for_User_Card_ExportStatementCardEndpoint.Request.Path(userID = userID, cardID = cardID, exportstatementcardID = exportstatementcardID)
      self.queries = List_all_Content_for_User_Card_ExportStatementCardEndpoint.Request.Queries()
      self.headers = List_all_Content_for_User_Card_ExportStatementCardEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  def to_raw_request(serialization: Wirespec.Serializer, request: Request) -> Wirespec.RawRequest:
    return Wirespec.RawRequest(
      path = ["user", str(request.path.userID), "card", str(request.path.cardID), "export-statement-card", str(request.path.export-statement-cardID), "content"],
  ...
  class Response200(Wirespec.Response[List[ExportStatementCardContentListing]]):
    ...
    body: List[ExportStatementCardContentListing] = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List[ExportStatementCardContentListing]):
      self.headers = List_all_Content_for_User_Card_ExportStatementCardEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[List_all_Content_for_User_Card_ExportStatementCard400ResponseBody]):
    ...
    body: List_all_Content_for_User_Card_ExportStatementCard400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List_all_Content_for_User_Card_ExportStatementCard400ResponseBody):
      self.headers = List_all_Content_for_User_Card_ExportStatementCardEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def List_all_Content_for_User_Card_ExportStatementCard(self, req: Request) -> Response: pass
