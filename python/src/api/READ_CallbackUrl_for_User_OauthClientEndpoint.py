...
class READ_CallbackUrl_for_User_OauthClientEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, oauthclientID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = READ_CallbackUrl_for_User_OauthClientEndpoint.Request.Path(userID = userID, oauthclientID = oauthclientID, itemId = itemId)
      self._queries = READ_CallbackUrl_for_User_OauthClientEndpoint.Request.Queries()
      self._headers = READ_CallbackUrl_for_User_OauthClientEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[OauthCallbackUrlRead]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: OauthCallbackUrlRead):
      self._headers = READ_CallbackUrl_for_User_OauthClientEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[READ_CallbackUrl_for_User_OauthClient400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: READ_CallbackUrl_for_User_OauthClient400ResponseBody):
      self._headers = READ_CallbackUrl_for_User_OauthClientEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def READ_CallbackUrl_for_User_OauthClient(self, req: 'READ_CallbackUrl_for_User_OauthClientEndpoint.Request') -> 'READ_CallbackUrl_for_User_OauthClientEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'READ_CallbackUrl_for_User_OauthClientEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'READ_CallbackUrl_for_User_OauthClientEndpoint.Request':
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'READ_CallbackUrl_for_User_OauthClientEndpoint.Response') -> Wirespec.RawResponse:
      match response:
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'READ_CallbackUrl_for_User_OauthClientEndpoint.Response':
