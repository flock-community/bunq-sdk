...
class DELETE_NoteText_for_User_MonetaryAccount_SchedulePaymentEndpoint (Wirespec.Endpoint):
  ...
  def to_raw_request(serialization: Wirespec.Serializer, request: Request) -> Wirespec.RawRequest:
    return Wirespec.RawRequest(
      path = ["user", request.path.userID, "monetary-account", request.path.monetary-accountID, "schedule-payment", request.path.schedule-paymentID, "note-text", request.path.itemId],
