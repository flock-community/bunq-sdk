...
class CREATE_AvatarEndpoint (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[Avatar]):
    ...
    def __init__(self, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: Avatar):
      self.path = CREATE_AvatarEndpoint.Request.Path()
      self.queries = CREATE_AvatarEndpoint.Request.Queries()
      self.headers = CREATE_AvatarEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> Request:
    return CREATE_AvatarEndpoint.Request(
  ...
  class Response200(Wirespec.Response[AvatarCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: AvatarCreate):
      self.headers = CREATE_AvatarEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_Avatar400ResponseBody]):
    ...
    body: CREATE_Avatar400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_Avatar400ResponseBody):
      self.headers = CREATE_AvatarEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  def to_raw_response(serialization: Wirespec.Serializer, response: Response) -> Wirespec.RawResponse:
    match response:
      case CREATE_AvatarEndpoint.Response200():
      ...
      case CREATE_AvatarEndpoint.Response400():
        return Wirespec.RawResponse(
          status_code = response.status,
          headers = {"XBunqClientResponseId": serialization.serialize_param(response.headers.XBunqClientResponseId, Optional[str]), "XBunqClientRequestId": serialization.serialize_param(response.headers.XBunqClientRequestId, Optional[str]), "XBunqServerSignature": serialization.serialize_param(response.headers.XBunqServerSignature, Optional[str])},
  ...
  def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> Response:
    match response.status_code:
      case 200:
        return CREATE_AvatarEndpoint.Response200(
      ...
      case 400:
        return CREATE_AvatarEndpoint.Response400(
  ...
  @abstractmethod
  def CREATE_Avatar(self, req: Request) -> Response: pass
