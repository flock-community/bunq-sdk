...
class READ_UserPaymentServiceProviderEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self.path = READ_UserPaymentServiceProviderEndpoint.Request.Path(itemId = itemId)
      self.queries = READ_UserPaymentServiceProviderEndpoint.Request.Queries()
      self.headers = READ_UserPaymentServiceProviderEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[UserPaymentServiceProviderRead]):
    ...
    body: UserPaymentServiceProviderRead = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UserPaymentServiceProviderRead):
      self.headers = READ_UserPaymentServiceProviderEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[READ_UserPaymentServiceProvider400ResponseBody]):
    ...
    body: READ_UserPaymentServiceProvider400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: READ_UserPaymentServiceProvider400ResponseBody):
      self.headers = READ_UserPaymentServiceProviderEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def READ_UserPaymentServiceProvider(self, req: Request) -> Response: pass
