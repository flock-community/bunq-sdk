...
class UPDATE_SchedulePayment_for_User_MonetaryAccountEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[SchedulePayment]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: SchedulePayment):
      self.path = UPDATE_SchedulePayment_for_User_MonetaryAccountEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, itemId = itemId)
      self.queries = UPDATE_SchedulePayment_for_User_MonetaryAccountEndpoint.Request.Queries()
      self.headers = UPDATE_SchedulePayment_for_User_MonetaryAccountEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  def to_raw_request(serialization: Wirespec.Serializer, request: Request) -> Wirespec.RawRequest:
    return Wirespec.RawRequest(
      path = ["user", str(request.path.userID), "monetary-account", str(request.path.monetary-accountID), "schedule-payment", str(request.path.itemId)],
  ...
  class Response200(Wirespec.Response[SchedulePaymentUpdate]):
    ...
    body: SchedulePaymentUpdate = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: SchedulePaymentUpdate):
      self.headers = UPDATE_SchedulePayment_for_User_MonetaryAccountEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_SchedulePayment_for_User_MonetaryAccount400ResponseBody]):
    ...
    body: UPDATE_SchedulePayment_for_User_MonetaryAccount400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_SchedulePayment_for_User_MonetaryAccount400ResponseBody):
      self.headers = UPDATE_SchedulePayment_for_User_MonetaryAccountEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def UPDATE_SchedulePayment_for_User_MonetaryAccount(self, req: Request) -> Response: pass
