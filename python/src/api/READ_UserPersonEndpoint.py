...
class READ_UserPersonEndpoint (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = READ_UserPersonEndpoint.Request.Path(itemId = itemId)
      self._queries = READ_UserPersonEndpoint.Request.Queries()
      self._headers = READ_UserPersonEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  @dataclass
  class Response200(Wirespec.Response[UserPersonRead]):
    @dataclass
    ...
    @property
    def body(self) -> UserPersonRead:
      return self._body

    _body: UserPersonRead
    _headers: Headers
    status: int = 200

    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UserPersonRead):
      self._headers = READ_UserPersonEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body

  @dataclass
  class Response400(Wirespec.Response[READ_UserPerson400ResponseBody]):
    @dataclass
    class Headers (Wirespec.Response.Headers):
        XBunqClientResponseId: 'Optional[str]'
        XBunqClientRequestId: 'Optional[str]'
    ...
    @property
    def body(self) -> READ_UserPerson400ResponseBody:
      return self._body

    _body: READ_UserPerson400ResponseBody
    _headers: Headers
    status: int = 400

    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: READ_UserPerson400ResponseBody):
      self._headers = READ_UserPersonEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def READ_UserPerson(self, req: 'READ_UserPersonEndpoint.Request') -> 'READ_UserPersonEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'READ_UserPersonEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'READ_UserPersonEndpoint.Request':
      return READ_UserPersonEndpoint.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'READ_UserPersonEndpoint.Response') -> Wirespec.RawResponse:
      match response:
        case READ_UserPersonEndpoint.Response200():
          return Wirespec.RawResponse(
            ...
            body = serialization.serialize(response.body, UserPersonRead),
          )
        case READ_UserPersonEndpoint.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
            body = serialization.serialize(response.body, READ_UserPerson400ResponseBody),
          )
        case _:
          raise Exception("Cannot match response with status: " + str(response.status))
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'READ_UserPersonEndpoint.Response':
      match response.status_code:
        case 200:
          return READ_UserPersonEndpoint.Response200(
            body = serialization.deserialize(response.body, UserPersonRead),
        ...
        case 400:
          return READ_UserPersonEndpoint.Response400(
            body = serialization.deserialize(response.body, READ_UserPerson400ResponseBody),
            XBunqClientResponseId = serialization.deserialize_param(response.headers.get("X-Bunq-Client-Response-Id".lower()), str),
            XBunqClientRequestId = serialization.deserialize_param(response.headers.get("X-Bunq-Client-Request-Id".lower()), str),
            XBunqServerSignature = serialization.deserialize_param(response.headers.get("X-Bunq-Server-Signature".lower()), str)
          )
