...
class DELETE_CustomerStatement_for_User_MonetaryAccountEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self.path = DELETE_CustomerStatement_for_User_MonetaryAccountEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, itemId = itemId)
      self.queries = DELETE_CustomerStatement_for_User_MonetaryAccountEndpoint.Request.Queries()
      self.headers = DELETE_CustomerStatement_for_User_MonetaryAccountEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  def to_raw_request(serialization: Wirespec.Serializer, request: Request) -> Wirespec.RawRequest:
    return Wirespec.RawRequest(
      path = ["user", str(request.path.userID), "monetary-account", str(request.path.monetary-accountID), "customer-statement", str(request.path.itemId)],
  ...
  class Response200(Wirespec.Response[ExportStatementDelete]):
    ...
    body: ExportStatementDelete = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: ExportStatementDelete):
      self.headers = DELETE_CustomerStatement_for_User_MonetaryAccountEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[DELETE_CustomerStatement_for_User_MonetaryAccount400ResponseBody]):
    ...
    body: DELETE_CustomerStatement_for_User_MonetaryAccount400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: DELETE_CustomerStatement_for_User_MonetaryAccount400ResponseBody):
      self.headers = DELETE_CustomerStatement_for_User_MonetaryAccountEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def DELETE_CustomerStatement_for_User_MonetaryAccount(self, req: Request) -> Response: pass
