...
class CREATE_GeneratedCvc2_for_User_CardEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[CardGeneratedCvc2]):
    ...
    def __init__(self, userID: int, cardID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: CardGeneratedCvc2):
      self.path = CREATE_GeneratedCvc2_for_User_CardEndpoint.Request.Path(userID = userID, cardID = cardID)
      self.queries = CREATE_GeneratedCvc2_for_User_CardEndpoint.Request.Queries()
      self.headers = CREATE_GeneratedCvc2_for_User_CardEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  def to_raw_request(serialization: Wirespec.Serializer, request: Request) -> Wirespec.RawRequest:
    return Wirespec.RawRequest(
      path = ["user", request.path.userID, "card", request.path.cardID, "generated-cvc2"],
  ...
  class Response200(Wirespec.Response[CardGeneratedCvc2Create]):
    ...
    body: CardGeneratedCvc2Create = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CardGeneratedCvc2Create):
      self.headers = CREATE_GeneratedCvc2_for_User_CardEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_GeneratedCvc2_for_User_Card400ResponseBody]):
    ...
    body: CREATE_GeneratedCvc2_for_User_Card400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_GeneratedCvc2_for_User_Card400ResponseBody):
      self.headers = CREATE_GeneratedCvc2_for_User_CardEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def CREATE_GeneratedCvc2_for_User_Card(self, req: Request) -> Response: pass
