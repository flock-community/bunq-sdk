...
class CREATE_GeneratedCvc2_for_User_CardEndpoint (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[CardGeneratedCvc2]):
    ...
    def __init__(self, userID: int, cardID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: CardGeneratedCvc2):
      self._path = CREATE_GeneratedCvc2_for_User_CardEndpoint.Request.Path(userID = userID, cardID = cardID)
      self._queries = CREATE_GeneratedCvc2_for_User_CardEndpoint.Request.Queries()
      self._headers = CREATE_GeneratedCvc2_for_User_CardEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[CardGeneratedCvc2Create]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CardGeneratedCvc2Create):
      self._headers = CREATE_GeneratedCvc2_for_User_CardEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_GeneratedCvc2_for_User_Card400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_GeneratedCvc2_for_User_Card400ResponseBody):
      self._headers = CREATE_GeneratedCvc2_for_User_CardEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def CREATE_GeneratedCvc2_for_User_Card(self, req: 'CREATE_GeneratedCvc2_for_User_CardEndpoint.Request') -> 'CREATE_GeneratedCvc2_for_User_CardEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'CREATE_GeneratedCvc2_for_User_CardEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'CREATE_GeneratedCvc2_for_User_CardEndpoint.Request':
      return CREATE_GeneratedCvc2_for_User_CardEndpoint.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'CREATE_GeneratedCvc2_for_User_CardEndpoint.Response') -> Wirespec.RawResponse:
      match response:
        case CREATE_GeneratedCvc2_for_User_CardEndpoint.Response200():
        ...
        case CREATE_GeneratedCvc2_for_User_CardEndpoint.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'CREATE_GeneratedCvc2_for_User_CardEndpoint.Response':
      match response.status_code:
        case 200:
          return CREATE_GeneratedCvc2_for_User_CardEndpoint.Response200(
        ...
        case 400:
          return CREATE_GeneratedCvc2_for_User_CardEndpoint.Response400(
