...
class DELETE_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, transferwisequoteID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = DELETE_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint.Request.Path(userID = userID, transferwisequoteID = transferwisequoteID, itemId = itemId)
      self._queries = DELETE_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint.Request.Queries()
      self._headers = DELETE_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[TransferwiseAccountQuoteDelete]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: TransferwiseAccountQuoteDelete):
      self._headers = DELETE_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[DELETE_TransferwiseRecipient_for_User_TransferwiseQuote400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: DELETE_TransferwiseRecipient_for_User_TransferwiseQuote400ResponseBody):
      self._headers = DELETE_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def DELETE_TransferwiseRecipient_for_User_TransferwiseQuote(self, req: 'DELETE_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint.Request') -> 'DELETE_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'DELETE_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'DELETE_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint.Request':
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'DELETE_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint.Response') -> Wirespec.RawResponse:
      match response:
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'DELETE_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint.Response':
