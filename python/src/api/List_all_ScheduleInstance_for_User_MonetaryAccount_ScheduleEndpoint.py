...
class List_all_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, scheduleID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = List_all_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, scheduleID = scheduleID)
      self._queries = List_all_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint.Request.Queries()
      self._headers = List_all_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[List[ScheduleInstanceListing]]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List[ScheduleInstanceListing]):
      self._headers = List_all_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule400ResponseBody):
      self._headers = List_all_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def List_all_ScheduleInstance_for_User_MonetaryAccount_Schedule(self, req: 'List_all_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint.Request') -> 'List_all_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'List_all_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'List_all_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint.Request':
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'List_all_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint.Response') -> Wirespec.RawResponse:
      match response:
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'List_all_ScheduleInstance_for_User_MonetaryAccount_ScheduleEndpoint.Response':
