...
class READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransactionEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, idealmerchanttransactionID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransactionEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, idealmerchanttransactionID = idealmerchanttransactionID, itemId = itemId)
      self._queries = READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransactionEndpoint.Request.Queries()
      self._headers = READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransactionEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteAttachmentIdealMerchantTransactionRead]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteAttachmentIdealMerchantTransactionRead):
      self._headers = READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransactionEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction400ResponseBody):
      self._headers = READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransactionEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransaction(self, req: 'READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransactionEndpoint.Request') -> 'READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransactionEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransactionEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransactionEndpoint.Request':
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransactionEndpoint.Response') -> Wirespec.RawResponse:
      match response:
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'READ_NoteAttachment_for_User_MonetaryAccount_IdealMerchantTransactionEndpoint.Response':
