...
class CREATE_Replace_for_User_CardEndpoint (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[CardReplace]):
    ...
    def __init__(self, userID: int, cardID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: CardReplace):
      self.path = CREATE_Replace_for_User_CardEndpoint.Request.Path(userID = userID, cardID = cardID)
      self.queries = CREATE_Replace_for_User_CardEndpoint.Request.Queries()
      self.headers = CREATE_Replace_for_User_CardEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> Request:
    return CREATE_Replace_for_User_CardEndpoint.Request(
  ...
  class Response200(Wirespec.Response[CardReplaceCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CardReplaceCreate):
      self.headers = CREATE_Replace_for_User_CardEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_Replace_for_User_Card400ResponseBody]):
    ...
    body: CREATE_Replace_for_User_Card400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_Replace_for_User_Card400ResponseBody):
      self.headers = CREATE_Replace_for_User_CardEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  def to_raw_response(serialization: Wirespec.Serializer, response: Response) -> Wirespec.RawResponse:
    match response:
      case CREATE_Replace_for_User_CardEndpoint.Response200():
      ...
      case CREATE_Replace_for_User_CardEndpoint.Response400():
        return Wirespec.RawResponse(
          status_code = response.status,
          headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, Optional[str]), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, Optional[str]), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, Optional[str])},
  ...
  def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> Response:
    match response.status_code:
      case 200:
        return CREATE_Replace_for_User_CardEndpoint.Response200(
      ...
      case 400:
        return CREATE_Replace_for_User_CardEndpoint.Response400(
  ...
  @abstractmethod
  def CREATE_Replace_for_User_Card(self, req: Request) -> Response: pass
