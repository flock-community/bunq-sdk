...
class CREATE_AttachmentPublicEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[AttachmentPublic]):
    ...
    def __init__(self, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: AttachmentPublic):
      self.path = CREATE_AttachmentPublicEndpoint.Request.Path()
      self.queries = CREATE_AttachmentPublicEndpoint.Request.Queries()
      self.headers = CREATE_AttachmentPublicEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[AttachmentPublicCreate]):
    ...
    body: AttachmentPublicCreate = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: AttachmentPublicCreate):
      self.headers = CREATE_AttachmentPublicEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_AttachmentPublic400ResponseBody]):
    ...
    body: CREATE_AttachmentPublic400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_AttachmentPublic400ResponseBody):
      self.headers = CREATE_AttachmentPublicEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def CREATE_AttachmentPublic(self, req: Request) -> Response: pass
