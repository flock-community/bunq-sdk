...
class UPDATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatchEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[NoteAttachmentSchedulePaymentBatch]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, schedulepaymentbatchID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteAttachmentSchedulePaymentBatch):
      self.path = UPDATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatchEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, schedulepaymentbatchID = schedulepaymentbatchID, itemId = itemId)
      self.queries = UPDATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatchEndpoint.Request.Queries()
      self.headers = UPDATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatchEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteAttachmentSchedulePaymentBatchUpdate]):
    ...
    body: NoteAttachmentSchedulePaymentBatchUpdate = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteAttachmentSchedulePaymentBatchUpdate):
      self.headers = UPDATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatchEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatch400ResponseBody]):
    ...
    body: UPDATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatch400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatch400ResponseBody):
      self.headers = UPDATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatchEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def UPDATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatch(self, req: Request) -> Response: pass
