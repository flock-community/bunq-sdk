...
class List_all_Content_for_User_ExportAnnualOverviewEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, exportannualoverviewID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self.path = List_all_Content_for_User_ExportAnnualOverviewEndpoint.Request.Path(userID = userID, exportannualoverviewID = exportannualoverviewID)
      self.queries = List_all_Content_for_User_ExportAnnualOverviewEndpoint.Request.Queries()
      self.headers = List_all_Content_for_User_ExportAnnualOverviewEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  def to_raw_request(serialization: Wirespec.Serializer, request: Request) -> Wirespec.RawRequest:
    return Wirespec.RawRequest(
      path = ["user", str(request.path.userID), "export-annual-overview", str(request.path.export-annual-overviewID), "content"],
  ...
  class Response200(Wirespec.Response[List[ExportAnnualOverviewContentListing]]):
    ...
    body: List[ExportAnnualOverviewContentListing] = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List[ExportAnnualOverviewContentListing]):
      self.headers = List_all_Content_for_User_ExportAnnualOverviewEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[List_all_Content_for_User_ExportAnnualOverview400ResponseBody]):
    ...
    body: List_all_Content_for_User_ExportAnnualOverview400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List_all_Content_for_User_ExportAnnualOverview400ResponseBody):
      self.headers = List_all_Content_for_User_ExportAnnualOverviewEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def List_all_Content_for_User_ExportAnnualOverview(self, req: Request) -> Response: pass
