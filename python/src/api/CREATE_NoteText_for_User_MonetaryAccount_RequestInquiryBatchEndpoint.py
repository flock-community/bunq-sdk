...
class CREATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[NoteTextRequestInquiryBatch]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, requestinquirybatchID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteTextRequestInquiryBatch):
      self._path = CREATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, requestinquirybatchID = requestinquirybatchID)
      self._queries = CREATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint.Request.Queries()
      self._headers = CREATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteTextRequestInquiryBatchCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteTextRequestInquiryBatchCreate):
      self._headers = CREATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatch400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatch400ResponseBody):
      self._headers = CREATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def CREATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatch(self, req: 'CREATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint.Request') -> 'CREATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'CREATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'CREATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint.Request':
      return CREATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'CREATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint.Response') -> Wirespec.RawResponse:
      match response:
        case CREATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint.Response200():
        ...
        case CREATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'CREATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint.Response':
      match response.status_code:
        case 200:
          return CREATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint.Response200(
        ...
        case 400:
          return CREATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint.Response400(
