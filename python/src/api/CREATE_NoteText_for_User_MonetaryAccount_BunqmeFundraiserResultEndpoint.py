...
class CREATE_NoteText_for_User_MonetaryAccount_BunqmeFundraiserResultEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[NoteTextBunqMeFundraiserResult]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, bunqmefundraiserresultID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteTextBunqMeFundraiserResult):
      self.path = CREATE_NoteText_for_User_MonetaryAccount_BunqmeFundraiserResultEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, bunqmefundraiserresultID = bunqmefundraiserresultID)
      self.queries = CREATE_NoteText_for_User_MonetaryAccount_BunqmeFundraiserResultEndpoint.Request.Queries()
      self.headers = CREATE_NoteText_for_User_MonetaryAccount_BunqmeFundraiserResultEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteTextBunqMeFundraiserResultCreate]):
    ...
    body: NoteTextBunqMeFundraiserResultCreate = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteTextBunqMeFundraiserResultCreate):
      self.headers = CREATE_NoteText_for_User_MonetaryAccount_BunqmeFundraiserResultEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_NoteText_for_User_MonetaryAccount_BunqmeFundraiserResult400ResponseBody]):
    ...
    body: CREATE_NoteText_for_User_MonetaryAccount_BunqmeFundraiserResult400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_NoteText_for_User_MonetaryAccount_BunqmeFundraiserResult400ResponseBody):
      self.headers = CREATE_NoteText_for_User_MonetaryAccount_BunqmeFundraiserResultEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def CREATE_NoteText_for_User_MonetaryAccount_BunqmeFundraiserResult(self, req: Request) -> Response: pass
