...
class UPDATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[NoteTextRequestInquiryBatch]):
    ...
    body: NoteTextRequestInquiryBatch = None
    ...
    def __init__(self, userID: int, monetaryaccountID: int, requestinquirybatchID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteTextRequestInquiryBatch):
      self.path = UPDATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, requestinquirybatchID = requestinquirybatchID, itemId = itemId)
      self.queries = UPDATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint.Request.Queries()
      self.headers = UPDATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteTextRequestInquiryBatchUpdate]):
    ...
    body: NoteTextRequestInquiryBatchUpdate = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteTextRequestInquiryBatchUpdate):
      self.headers = UPDATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatch400ResponseBody]):
    ...
    body: UPDATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatch400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatch400ResponseBody):
      self.headers = UPDATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatchEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def UPDATE_NoteText_for_User_MonetaryAccount_RequestInquiryBatch(self, req: Request) -> Response: pass
