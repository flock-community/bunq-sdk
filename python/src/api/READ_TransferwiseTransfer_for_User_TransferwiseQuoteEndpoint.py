...
class READ_TransferwiseTransfer_for_User_TransferwiseQuoteEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, transferwisequoteID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self.path = READ_TransferwiseTransfer_for_User_TransferwiseQuoteEndpoint.Request.Path(userID = userID, transferwisequoteID = transferwisequoteID, itemId = itemId)
      self.queries = READ_TransferwiseTransfer_for_User_TransferwiseQuoteEndpoint.Request.Queries()
      self.headers = READ_TransferwiseTransfer_for_User_TransferwiseQuoteEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  def to_raw_request(serialization: Wirespec.Serializer, request: Request) -> Wirespec.RawRequest:
    return Wirespec.RawRequest(
      path = ["user", str(request.path.userID), "transferwise-quote", str(request.path.transferwise-quoteID), "transferwise-transfer", str(request.path.itemId)],
  ...
  class Response200(Wirespec.Response[TransferwiseTransferRead]):
    ...
    body: TransferwiseTransferRead = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: TransferwiseTransferRead):
      self.headers = READ_TransferwiseTransfer_for_User_TransferwiseQuoteEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[READ_TransferwiseTransfer_for_User_TransferwiseQuote400ResponseBody]):
    ...
    body: READ_TransferwiseTransfer_for_User_TransferwiseQuote400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: READ_TransferwiseTransfer_for_User_TransferwiseQuote400ResponseBody):
      self.headers = READ_TransferwiseTransfer_for_User_TransferwiseQuoteEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def READ_TransferwiseTransfer_for_User_TransferwiseQuote(self, req: Request) -> Response: pass
