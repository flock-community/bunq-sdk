...
class List_all_Ip_for_User_CredentialPasswordIpEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, credentialpasswordipID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self.path = List_all_Ip_for_User_CredentialPasswordIpEndpoint.Request.Path(userID = userID, credentialpasswordipID = credentialpasswordipID)
      self.queries = List_all_Ip_for_User_CredentialPasswordIpEndpoint.Request.Queries()
      self.headers = List_all_Ip_for_User_CredentialPasswordIpEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  def to_raw_request(serialization: Wirespec.Serializer, request: Request) -> Wirespec.RawRequest:
    return Wirespec.RawRequest(
      path = ["user", str(request.path.userID), "credential-password-ip", str(request.path.credential-password-ipID), "ip"],
  ...
  class Response200(Wirespec.Response[List[PermittedIpListing]]):
    ...
    body: List[PermittedIpListing] = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List[PermittedIpListing]):
      self.headers = List_all_Ip_for_User_CredentialPasswordIpEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[List_all_Ip_for_User_CredentialPasswordIp400ResponseBody]):
    ...
    body: List_all_Ip_for_User_CredentialPasswordIp400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List_all_Ip_for_User_CredentialPasswordIp400ResponseBody):
      self.headers = List_all_Ip_for_User_CredentialPasswordIpEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def List_all_Ip_for_User_CredentialPasswordIp(self, req: Request) -> Response: pass
