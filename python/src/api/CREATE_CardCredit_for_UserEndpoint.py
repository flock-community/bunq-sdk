...
class CREATE_CardCredit_for_UserEndpoint (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[CardCredit]):
    ...
    def __init__(self, userID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: CardCredit):
      self.path = CREATE_CardCredit_for_UserEndpoint.Request.Path(userID = userID)
      self.queries = CREATE_CardCredit_for_UserEndpoint.Request.Queries()
      self.headers = CREATE_CardCredit_for_UserEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> Request:
    return CREATE_CardCredit_for_UserEndpoint.Request(
  ...
  class Response200(Wirespec.Response[CardCreditCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CardCreditCreate):
      self.headers = CREATE_CardCredit_for_UserEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_CardCredit_for_User400ResponseBody]):
    ...
    body: CREATE_CardCredit_for_User400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_CardCredit_for_User400ResponseBody):
      self.headers = CREATE_CardCredit_for_UserEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  def to_raw_response(serialization: Wirespec.Serializer, response: Response) -> Wirespec.RawResponse:
    match response:
      case CREATE_CardCredit_for_UserEndpoint.Response200():
      ...
      case CREATE_CardCredit_for_UserEndpoint.Response400():
        return Wirespec.RawResponse(
          status_code = response.status,
          headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, Optional[str]), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, Optional[str]), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, Optional[str])},
  ...
  def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> Response:
    match response.status_code:
      case 200:
        return CREATE_CardCredit_for_UserEndpoint.Response200(
      ...
      case 400:
        return CREATE_CardCredit_for_UserEndpoint.Response400(
  ...
  @abstractmethod
  def CREATE_CardCredit_for_User(self, req: Request) -> Response: pass
