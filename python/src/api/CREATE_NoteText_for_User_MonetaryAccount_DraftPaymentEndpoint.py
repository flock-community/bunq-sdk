...
class CREATE_NoteText_for_User_MonetaryAccount_DraftPaymentEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[NoteTextDraftPayment]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, draftpaymentID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteTextDraftPayment):
      self._path = CREATE_NoteText_for_User_MonetaryAccount_DraftPaymentEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, draftpaymentID = draftpaymentID)
      self._queries = CREATE_NoteText_for_User_MonetaryAccount_DraftPaymentEndpoint.Request.Queries()
      self._headers = CREATE_NoteText_for_User_MonetaryAccount_DraftPaymentEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteTextDraftPaymentCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteTextDraftPaymentCreate):
      self._headers = CREATE_NoteText_for_User_MonetaryAccount_DraftPaymentEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_NoteText_for_User_MonetaryAccount_DraftPayment400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_NoteText_for_User_MonetaryAccount_DraftPayment400ResponseBody):
      self._headers = CREATE_NoteText_for_User_MonetaryAccount_DraftPaymentEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def CREATE_NoteText_for_User_MonetaryAccount_DraftPayment(self, req: 'CREATE_NoteText_for_User_MonetaryAccount_DraftPaymentEndpoint.Request') -> 'CREATE_NoteText_for_User_MonetaryAccount_DraftPaymentEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'CREATE_NoteText_for_User_MonetaryAccount_DraftPaymentEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'CREATE_NoteText_for_User_MonetaryAccount_DraftPaymentEndpoint.Request':
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'CREATE_NoteText_for_User_MonetaryAccount_DraftPaymentEndpoint.Response') -> Wirespec.RawResponse:
      match response:
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'CREATE_NoteText_for_User_MonetaryAccount_DraftPaymentEndpoint.Response':
