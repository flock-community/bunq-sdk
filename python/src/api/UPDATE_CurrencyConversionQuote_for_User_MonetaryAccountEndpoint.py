...
class UPDATE_CurrencyConversionQuote_for_User_MonetaryAccountEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[CurrencyConversionQuote]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: CurrencyConversionQuote):
      self._path = UPDATE_CurrencyConversionQuote_for_User_MonetaryAccountEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, itemId = itemId)
      self._queries = UPDATE_CurrencyConversionQuote_for_User_MonetaryAccountEndpoint.Request.Queries()
      self._headers = UPDATE_CurrencyConversionQuote_for_User_MonetaryAccountEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[CurrencyConversionQuoteUpdate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CurrencyConversionQuoteUpdate):
      self._headers = UPDATE_CurrencyConversionQuote_for_User_MonetaryAccountEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount400ResponseBody):
      self._headers = UPDATE_CurrencyConversionQuote_for_User_MonetaryAccountEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def UPDATE_CurrencyConversionQuote_for_User_MonetaryAccount(self, req: 'UPDATE_CurrencyConversionQuote_for_User_MonetaryAccountEndpoint.Request') -> 'UPDATE_CurrencyConversionQuote_for_User_MonetaryAccountEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'UPDATE_CurrencyConversionQuote_for_User_MonetaryAccountEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'UPDATE_CurrencyConversionQuote_for_User_MonetaryAccountEndpoint.Request':
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'UPDATE_CurrencyConversionQuote_for_User_MonetaryAccountEndpoint.Response') -> Wirespec.RawResponse:
      match response:
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'UPDATE_CurrencyConversionQuote_for_User_MonetaryAccountEndpoint.Response':
