...
class List_all_MonetaryAccountExternalSavings_for_UserEndpoint (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = List_all_MonetaryAccountExternalSavings_for_UserEndpoint.Request.Path(userID = userID)
      self._queries = List_all_MonetaryAccountExternalSavings_for_UserEndpoint.Request.Queries()
      self._headers = List_all_MonetaryAccountExternalSavings_for_UserEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[List[MonetaryAccountExternalSavingsListing]]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List[MonetaryAccountExternalSavingsListing]):
      self._headers = List_all_MonetaryAccountExternalSavings_for_UserEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[List_all_MonetaryAccountExternalSavings_for_User400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List_all_MonetaryAccountExternalSavings_for_User400ResponseBody):
      self._headers = List_all_MonetaryAccountExternalSavings_for_UserEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def List_all_MonetaryAccountExternalSavings_for_User(self, req: 'List_all_MonetaryAccountExternalSavings_for_UserEndpoint.Request') -> 'List_all_MonetaryAccountExternalSavings_for_UserEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'List_all_MonetaryAccountExternalSavings_for_UserEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'List_all_MonetaryAccountExternalSavings_for_UserEndpoint.Request':
      return List_all_MonetaryAccountExternalSavings_for_UserEndpoint.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'List_all_MonetaryAccountExternalSavings_for_UserEndpoint.Response') -> Wirespec.RawResponse:
      match response:
        case List_all_MonetaryAccountExternalSavings_for_UserEndpoint.Response200():
        ...
        case List_all_MonetaryAccountExternalSavings_for_UserEndpoint.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'List_all_MonetaryAccountExternalSavings_for_UserEndpoint.Response':
      match response.status_code:
        case 200:
          return List_all_MonetaryAccountExternalSavings_for_UserEndpoint.Response200(
        ...
        case 400:
          return List_all_MonetaryAccountExternalSavings_for_UserEndpoint.Response400(
