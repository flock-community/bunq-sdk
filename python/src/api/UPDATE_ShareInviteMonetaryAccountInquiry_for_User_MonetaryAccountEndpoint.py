...
class UPDATE_ShareInviteMonetaryAccountInquiry_for_User_MonetaryAccountEndpoint (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[ShareInviteMonetaryAccountInquiry]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: ShareInviteMonetaryAccountInquiry):
      self._path = UPDATE_ShareInviteMonetaryAccountInquiry_for_User_MonetaryAccountEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, itemId = itemId)
      self._queries = UPDATE_ShareInviteMonetaryAccountInquiry_for_User_MonetaryAccountEndpoint.Request.Queries()
      self._headers = UPDATE_ShareInviteMonetaryAccountInquiry_for_User_MonetaryAccountEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[ShareInviteMonetaryAccountInquiryUpdate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: ShareInviteMonetaryAccountInquiryUpdate):
      self._headers = UPDATE_ShareInviteMonetaryAccountInquiry_for_User_MonetaryAccountEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_ShareInviteMonetaryAccountInquiry_for_User_MonetaryAccount400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_ShareInviteMonetaryAccountInquiry_for_User_MonetaryAccount400ResponseBody):
      self._headers = UPDATE_ShareInviteMonetaryAccountInquiry_for_User_MonetaryAccountEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def UPDATE_ShareInviteMonetaryAccountInquiry_for_User_MonetaryAccount(self, req: 'UPDATE_ShareInviteMonetaryAccountInquiry_for_User_MonetaryAccountEndpoint.Request') -> 'UPDATE_ShareInviteMonetaryAccountInquiry_for_User_MonetaryAccountEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'UPDATE_ShareInviteMonetaryAccountInquiry_for_User_MonetaryAccountEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'UPDATE_ShareInviteMonetaryAccountInquiry_for_User_MonetaryAccountEndpoint.Request':
      return UPDATE_ShareInviteMonetaryAccountInquiry_for_User_MonetaryAccountEndpoint.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'UPDATE_ShareInviteMonetaryAccountInquiry_for_User_MonetaryAccountEndpoint.Response') -> Wirespec.RawResponse:
      match response:
        case UPDATE_ShareInviteMonetaryAccountInquiry_for_User_MonetaryAccountEndpoint.Response200():
        ...
        case UPDATE_ShareInviteMonetaryAccountInquiry_for_User_MonetaryAccountEndpoint.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'UPDATE_ShareInviteMonetaryAccountInquiry_for_User_MonetaryAccountEndpoint.Response':
      match response.status_code:
        case 200:
          return UPDATE_ShareInviteMonetaryAccountInquiry_for_User_MonetaryAccountEndpoint.Response200(
        ...
        case 400:
          return UPDATE_ShareInviteMonetaryAccountInquiry_for_User_MonetaryAccountEndpoint.Response400(
