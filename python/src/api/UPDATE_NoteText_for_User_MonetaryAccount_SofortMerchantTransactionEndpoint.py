...
class UPDATE_NoteText_for_User_MonetaryAccount_SofortMerchantTransactionEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[NoteTextSofortMerchantTransaction]):
    ...
    body: NoteTextSofortMerchantTransaction = None
    ...
    def __init__(self, userID: int, monetaryaccountID: int, sofortmerchanttransactionID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteTextSofortMerchantTransaction):
      self.path = UPDATE_NoteText_for_User_MonetaryAccount_SofortMerchantTransactionEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, sofortmerchanttransactionID = sofortmerchanttransactionID, itemId = itemId)
      self.queries = UPDATE_NoteText_for_User_MonetaryAccount_SofortMerchantTransactionEndpoint.Request.Queries()
      self.headers = UPDATE_NoteText_for_User_MonetaryAccount_SofortMerchantTransactionEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteTextSofortMerchantTransactionUpdate]):
    ...
    body: NoteTextSofortMerchantTransactionUpdate = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteTextSofortMerchantTransactionUpdate):
      self.headers = UPDATE_NoteText_for_User_MonetaryAccount_SofortMerchantTransactionEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_NoteText_for_User_MonetaryAccount_SofortMerchantTransaction400ResponseBody]):
    ...
    body: UPDATE_NoteText_for_User_MonetaryAccount_SofortMerchantTransaction400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_NoteText_for_User_MonetaryAccount_SofortMerchantTransaction400ResponseBody):
      self.headers = UPDATE_NoteText_for_User_MonetaryAccount_SofortMerchantTransactionEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def UPDATE_NoteText_for_User_MonetaryAccount_SofortMerchantTransaction(self, req: Request) -> Response: pass
