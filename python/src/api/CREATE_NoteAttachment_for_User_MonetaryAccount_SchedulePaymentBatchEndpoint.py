...
class CREATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatchEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[NoteAttachmentSchedulePaymentBatch]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, schedulepaymentbatchID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteAttachmentSchedulePaymentBatch):
      self._path = CREATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatchEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, schedulepaymentbatchID = schedulepaymentbatchID)
      self._queries = CREATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatchEndpoint.Request.Queries()
      self._headers = CREATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatchEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteAttachmentSchedulePaymentBatchCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteAttachmentSchedulePaymentBatchCreate):
      self._headers = CREATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatchEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatch400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatch400ResponseBody):
      self._headers = CREATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatchEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def CREATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatch(self, req: 'CREATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatchEndpoint.Request') -> 'CREATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatchEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'CREATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatchEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'CREATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatchEndpoint.Request':
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'CREATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatchEndpoint.Response') -> Wirespec.RawResponse:
      match response:
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'CREATE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentBatchEndpoint.Response':
