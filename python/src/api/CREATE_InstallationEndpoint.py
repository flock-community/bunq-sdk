...
class CREATE_InstallationEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[Installation]):
    ...
    def __init__(self, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: Installation):
      self.path = CREATE_InstallationEndpoint.Request.Path()
      self.queries = CREATE_InstallationEndpoint.Request.Queries()
      self.headers = CREATE_InstallationEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[InstallationCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: InstallationCreate):
      self.headers = CREATE_InstallationEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_Installation400ResponseBody]):
    ...
    body: CREATE_Installation400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_Installation400ResponseBody):
      self.headers = CREATE_InstallationEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def CREATE_Installation(self, req: Request) -> Response: pass
