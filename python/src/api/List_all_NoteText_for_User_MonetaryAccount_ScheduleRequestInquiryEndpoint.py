...
class List_all_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiryEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, schedulerequestinquiryID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = List_all_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiryEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, schedulerequestinquiryID = schedulerequestinquiryID)
      self._queries = List_all_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiryEndpoint.Request.Queries()
      self._headers = List_all_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiryEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[List[NoteTextScheduleRequestListing]]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List[NoteTextScheduleRequestListing]):
      self._headers = List_all_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiryEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[List_all_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List_all_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry400ResponseBody):
      self._headers = List_all_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiryEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def List_all_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiry(self, req: 'List_all_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiryEndpoint.Request') -> 'List_all_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiryEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'List_all_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiryEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'List_all_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiryEndpoint.Request':
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'List_all_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiryEndpoint.Response') -> Wirespec.RawResponse:
      match response:
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'List_all_NoteText_for_User_MonetaryAccount_ScheduleRequestInquiryEndpoint.Response':
