...
class UPDATE_NoteText_for_User_MonetaryAccount_SchedulePaymentEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[NoteTextSchedulePayment]):
    ...
    body: NoteTextSchedulePayment = None
    ...
    def __init__(self, userID: int, monetaryaccountID: int, schedulepaymentID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteTextSchedulePayment):
      self.path = UPDATE_NoteText_for_User_MonetaryAccount_SchedulePaymentEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, schedulepaymentID = schedulepaymentID, itemId = itemId)
      self.queries = UPDATE_NoteText_for_User_MonetaryAccount_SchedulePaymentEndpoint.Request.Queries()
      self.headers = UPDATE_NoteText_for_User_MonetaryAccount_SchedulePaymentEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteTextSchedulePaymentUpdate]):
    ...
    body: NoteTextSchedulePaymentUpdate = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteTextSchedulePaymentUpdate):
      self.headers = UPDATE_NoteText_for_User_MonetaryAccount_SchedulePaymentEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment400ResponseBody]):
    ...
    body: UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment400ResponseBody):
      self.headers = UPDATE_NoteText_for_User_MonetaryAccount_SchedulePaymentEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def UPDATE_NoteText_for_User_MonetaryAccount_SchedulePayment(self, req: Request) -> Response: pass
