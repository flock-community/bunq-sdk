...
class UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResultEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[NoteAttachmentBunqMeFundraiserResult]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, bunqmefundraiserresultID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteAttachmentBunqMeFundraiserResult):
      self._path = UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResultEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, bunqmefundraiserresultID = bunqmefundraiserresultID, itemId = itemId)
      self._queries = UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResultEndpoint.Request.Queries()
      self._headers = UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResultEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteAttachmentBunqMeFundraiserResultUpdate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteAttachmentBunqMeFundraiserResultUpdate):
      self._headers = UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResultEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult400ResponseBody):
      self._headers = UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResultEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResult(self, req: 'UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResultEndpoint.Request') -> 'UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResultEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResultEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResultEndpoint.Request':
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResultEndpoint.Response') -> Wirespec.RawResponse:
      match response:
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'UPDATE_NoteAttachment_for_User_MonetaryAccount_BunqmeFundraiserResultEndpoint.Response':
