...
class CREATE_ServerErrorEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[ServerError]):
    ...
    def __init__(self, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: ServerError):
      self.path = CREATE_ServerErrorEndpoint.Request.Path()
      self.queries = CREATE_ServerErrorEndpoint.Request.Queries()
      self.headers = CREATE_ServerErrorEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[ServerErrorCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: ServerErrorCreate):
      self.headers = CREATE_ServerErrorEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_ServerError400ResponseBody]):
    ...
    body: CREATE_ServerError400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_ServerError400ResponseBody):
      self.headers = CREATE_ServerErrorEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def CREATE_ServerError(self, req: Request) -> Response: pass
