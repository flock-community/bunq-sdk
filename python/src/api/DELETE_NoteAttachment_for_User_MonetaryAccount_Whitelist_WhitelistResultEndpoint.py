...
class DELETE_NoteAttachment_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, whitelistID: int, whitelistresultID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = DELETE_NoteAttachment_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, whitelistID = whitelistID, whitelistresultID = whitelistresultID, itemId = itemId)
      self._queries = DELETE_NoteAttachment_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint.Request.Queries()
      self._headers = DELETE_NoteAttachment_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteAttachmentWhitelistResultDelete]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteAttachmentWhitelistResultDelete):
      self._headers = DELETE_NoteAttachment_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[DELETE_NoteAttachment_for_User_MonetaryAccount_Whitelist_WhitelistResult400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: DELETE_NoteAttachment_for_User_MonetaryAccount_Whitelist_WhitelistResult400ResponseBody):
      self._headers = DELETE_NoteAttachment_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def DELETE_NoteAttachment_for_User_MonetaryAccount_Whitelist_WhitelistResult(self, req: 'DELETE_NoteAttachment_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint.Request') -> 'DELETE_NoteAttachment_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'DELETE_NoteAttachment_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'DELETE_NoteAttachment_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint.Request':
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'DELETE_NoteAttachment_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint.Response') -> Wirespec.RawResponse:
      match response:
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'DELETE_NoteAttachment_for_User_MonetaryAccount_Whitelist_WhitelistResultEndpoint.Response':
