...
class CREATE_CardDebit_for_UserEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[CardDebit]):
    ...
    def __init__(self, userID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: CardDebit):
      self.path = CREATE_CardDebit_for_UserEndpoint.Request.Path(userID = userID)
      self.queries = CREATE_CardDebit_for_UserEndpoint.Request.Queries()
      self.headers = CREATE_CardDebit_for_UserEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[CardDebitCreate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CardDebitCreate):
      self.headers = CREATE_CardDebit_for_UserEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_CardDebit_for_User400ResponseBody]):
    ...
    body: CREATE_CardDebit_for_User400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_CardDebit_for_User400ResponseBody):
      self.headers = CREATE_CardDebit_for_UserEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def CREATE_CardDebit_for_User(self, req: Request) -> Response: pass
