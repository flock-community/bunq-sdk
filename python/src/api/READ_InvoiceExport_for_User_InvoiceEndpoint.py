...
class READ_InvoiceExport_for_User_InvoiceEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, invoiceID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self.path = READ_InvoiceExport_for_User_InvoiceEndpoint.Request.Path(userID = userID, invoiceID = invoiceID, itemId = itemId)
      self.queries = READ_InvoiceExport_for_User_InvoiceEndpoint.Request.Queries()
      self.headers = READ_InvoiceExport_for_User_InvoiceEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[InvoiceExportPdfRead]):
    ...
    body: InvoiceExportPdfRead = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: InvoiceExportPdfRead):
      self.headers = READ_InvoiceExport_for_User_InvoiceEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[READ_InvoiceExport_for_User_Invoice400ResponseBody]):
    ...
    body: READ_InvoiceExport_for_User_Invoice400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: READ_InvoiceExport_for_User_Invoice400ResponseBody):
      self.headers = READ_InvoiceExport_for_User_InvoiceEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def READ_InvoiceExport_for_User_Invoice(self, req: Request) -> Response: pass
