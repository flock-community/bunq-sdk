...
class READ_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, schedulepaymentID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self.path = READ_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, schedulepaymentID = schedulepaymentID, itemId = itemId)
      self.queries = READ_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentEndpoint.Request.Queries()
      self.headers = READ_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteAttachmentSchedulePaymentRead]):
    ...
    body: NoteAttachmentSchedulePaymentRead = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteAttachmentSchedulePaymentRead):
      self.headers = READ_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[READ_NoteAttachment_for_User_MonetaryAccount_SchedulePayment400ResponseBody]):
    ...
    body: READ_NoteAttachment_for_User_MonetaryAccount_SchedulePayment400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: READ_NoteAttachment_for_User_MonetaryAccount_SchedulePayment400ResponseBody):
      self.headers = READ_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def READ_NoteAttachment_for_User_MonetaryAccount_SchedulePayment(self, req: Request) -> Response: pass
