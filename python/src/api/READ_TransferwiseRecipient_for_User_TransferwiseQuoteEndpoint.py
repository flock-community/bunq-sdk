...
class READ_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, transferwisequoteID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = READ_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint.Request.Path(userID = userID, transferwisequoteID = transferwisequoteID, itemId = itemId)
      self._queries = READ_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint.Request.Queries()
      self._headers = READ_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[TransferwiseAccountQuoteRead]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: TransferwiseAccountQuoteRead):
      self._headers = READ_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[READ_TransferwiseRecipient_for_User_TransferwiseQuote400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: READ_TransferwiseRecipient_for_User_TransferwiseQuote400ResponseBody):
      self._headers = READ_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def READ_TransferwiseRecipient_for_User_TransferwiseQuote(self, req: 'READ_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint.Request') -> 'READ_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'READ_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'READ_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint.Request':
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'READ_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint.Response') -> Wirespec.RawResponse:
      match response:
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'READ_TransferwiseRecipient_for_User_TransferwiseQuoteEndpoint.Response':
