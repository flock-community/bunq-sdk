...
class CREATE_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransactionEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[NoteTextOpenBankingMerchantTransaction]):
    ...
    body: NoteTextOpenBankingMerchantTransaction = None
    ...
    def __init__(self, userID: int, monetaryaccountID: int, openbankingmerchanttransactionID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteTextOpenBankingMerchantTransaction):
      self.path = CREATE_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransactionEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, openbankingmerchanttransactionID = openbankingmerchanttransactionID)
      self.queries = CREATE_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransactionEndpoint.Request.Queries()
      self.headers = CREATE_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransactionEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  def to_raw_request(serialization: Wirespec.Serializer, request: Request) -> Wirespec.RawRequest:
    return Wirespec.RawRequest(
      path = ["user", request.path.userID, "monetary-account", request.path.monetary-accountID, "open-banking-merchant-transaction", request.path.open-banking-merchant-transactionID, "note-text"],
  ...
  class Response200(Wirespec.Response[NoteTextOpenBankingMerchantTransactionCreate]):
    ...
    body: NoteTextOpenBankingMerchantTransactionCreate = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteTextOpenBankingMerchantTransactionCreate):
      self.headers = CREATE_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransactionEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction400ResponseBody]):
    ...
    body: CREATE_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction400ResponseBody):
      self.headers = CREATE_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransactionEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def CREATE_NoteText_for_User_MonetaryAccount_OpenBankingMerchantTransaction(self, req: Request) -> Response: pass
