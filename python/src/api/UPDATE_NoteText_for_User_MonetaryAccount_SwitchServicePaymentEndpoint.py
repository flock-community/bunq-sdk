...
class UPDATE_NoteText_for_User_MonetaryAccount_SwitchServicePaymentEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[NoteTextBankSwitchServiceNetherlandsIncomingPayment]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, switchservicepaymentID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: NoteTextBankSwitchServiceNetherlandsIncomingPayment):
      self.path = UPDATE_NoteText_for_User_MonetaryAccount_SwitchServicePaymentEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, switchservicepaymentID = switchservicepaymentID, itemId = itemId)
      self.queries = UPDATE_NoteText_for_User_MonetaryAccount_SwitchServicePaymentEndpoint.Request.Queries()
      self.headers = UPDATE_NoteText_for_User_MonetaryAccount_SwitchServicePaymentEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteTextBankSwitchServiceNetherlandsIncomingPaymentUpdate]):
    ...
    body: NoteTextBankSwitchServiceNetherlandsIncomingPaymentUpdate = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteTextBankSwitchServiceNetherlandsIncomingPaymentUpdate):
      self.headers = UPDATE_NoteText_for_User_MonetaryAccount_SwitchServicePaymentEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_NoteText_for_User_MonetaryAccount_SwitchServicePayment400ResponseBody]):
    ...
    body: UPDATE_NoteText_for_User_MonetaryAccount_SwitchServicePayment400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_NoteText_for_User_MonetaryAccount_SwitchServicePayment400ResponseBody):
      self.headers = UPDATE_NoteText_for_User_MonetaryAccount_SwitchServicePaymentEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def UPDATE_NoteText_for_User_MonetaryAccount_SwitchServicePayment(self, req: Request) -> Response: pass
