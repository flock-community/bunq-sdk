...
class List_all_Card_for_UserEndpoint (Wirespec.Endpoint):
  @dataclass
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = List_all_Card_for_UserEndpoint.Request.Path(userID = userID)
      self._queries = List_all_Card_for_UserEndpoint.Request.Queries()
      self._headers = List_all_Card_for_UserEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  @dataclass
  class Response200(Wirespec.Response[List[CardListing]]):
    @dataclass
    ...
    @property
    def body(self) -> List[CardListing]:
      return self._body

    _body: List[CardListing]
    _headers: Headers
    status: int = 200

    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List[CardListing]):
      self._headers = List_all_Card_for_UserEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body

  @dataclass
  class Response400(Wirespec.Response[List_all_Card_for_User400ResponseBody]):
    @dataclass
    class Headers (Wirespec.Response.Headers):
        XBunqClientResponseId: 'Optional[str]'
        XBunqClientRequestId: 'Optional[str]'
    ...
    @property
    def body(self) -> List_all_Card_for_User400ResponseBody:
      return self._body

    _body: List_all_Card_for_User400ResponseBody
    _headers: Headers
    status: int = 400

    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: List_all_Card_for_User400ResponseBody):
      self._headers = List_all_Card_for_UserEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def List_all_Card_for_User(self, req: 'List_all_Card_for_UserEndpoint.Request') -> 'List_all_Card_for_UserEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'List_all_Card_for_UserEndpoint.Request') -> Wirespec.RawRequest:
      return Wirespec.RawRequest(
        path = ["user", str(request.path.userID), "card"],
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'List_all_Card_for_UserEndpoint.Request':
      return List_all_Card_for_UserEndpoint.Request(
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'List_all_Card_for_UserEndpoint.Response') -> Wirespec.RawResponse:
      match response:
        case List_all_Card_for_UserEndpoint.Response200():
          return Wirespec.RawResponse(
            ...
            body = serialization.serialize(response.body, List[CardListing]),
          )
        case List_all_Card_for_UserEndpoint.Response400():
          return Wirespec.RawResponse(
            status_code = response.status,
            headers = {"X-Bunq-Client-Response-Id": serialization.serialize_param(response.headers.XBunqClientResponseId, str), "X-Bunq-Client-Request-Id": serialization.serialize_param(response.headers.XBunqClientRequestId, str), "X-Bunq-Server-Signature": serialization.serialize_param(response.headers.XBunqServerSignature, str)},
            body = serialization.serialize(response.body, List_all_Card_for_User400ResponseBody),
          )
        case _:
          raise Exception("Cannot match response with status: " + str(response.status))
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'List_all_Card_for_UserEndpoint.Response':
      match response.status_code:
        case 200:
          return List_all_Card_for_UserEndpoint.Response200(
            body = serialization.deserialize(response.body, List[CardListing]),
        ...
        case 400:
          return List_all_Card_for_UserEndpoint.Response400(
            body = serialization.deserialize(response.body, List_all_Card_for_User400ResponseBody),
            XBunqClientResponseId = serialization.deserialize_param(response.headers.get("X-Bunq-Client-Response-Id".lower()), str),
            XBunqClientRequestId = serialization.deserialize_param(response.headers.get("X-Bunq-Client-Request-Id".lower()), str),
            XBunqServerSignature = serialization.deserialize_param(response.headers.get("X-Bunq-Server-Signature".lower()), str)
          )
