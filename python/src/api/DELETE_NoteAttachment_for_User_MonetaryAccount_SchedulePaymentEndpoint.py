...
class DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, monetaryaccountID: int, schedulepaymentID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self._path = DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentEndpoint.Request.Path(userID = userID, monetaryaccountID = monetaryaccountID, schedulepaymentID = schedulepaymentID, itemId = itemId)
      self._queries = DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentEndpoint.Request.Queries()
      self._headers = DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[NoteAttachmentSchedulePaymentDelete]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: NoteAttachmentSchedulePaymentDelete):
      self._headers = DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment400ResponseBody]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment400ResponseBody):
      self._headers = DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self._body = body
  ...
  class Handler(Wirespec.Endpoint.Handler):
    @abstractmethod
    def DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePayment(self, req: 'DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentEndpoint.Request') -> 'DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentEndpoint.Response': pass

  class Convert(Wirespec.Endpoint.Convert[Request, Response]):
    @staticmethod
    def to_raw_request(serialization: Wirespec.Serializer, request: 'DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentEndpoint.Request') -> Wirespec.RawRequest:
    ...
    @staticmethod
    def from_raw_request(serialization: Wirespec.Deserializer, request: Wirespec.RawRequest) -> 'DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentEndpoint.Request':
    ...
    @staticmethod
    def to_raw_response(serialization: Wirespec.Serializer, response: 'DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentEndpoint.Response') -> Wirespec.RawResponse:
      match response:
    ...
    @staticmethod
    def from_raw_response(serialization: Wirespec.Deserializer, response: Wirespec.RawResponse) -> 'DELETE_NoteAttachment_for_User_MonetaryAccount_SchedulePaymentEndpoint.Response':
