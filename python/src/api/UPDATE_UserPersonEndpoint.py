...
class UPDATE_UserPersonEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[UserPerson]):
    ...
    def __init__(self, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: UserPerson):
      self.path = UPDATE_UserPersonEndpoint.Request.Path(itemId = itemId)
      self.queries = UPDATE_UserPersonEndpoint.Request.Queries()
      self.headers = UPDATE_UserPersonEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[UserPersonUpdate]):
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UserPersonUpdate):
      self.headers = UPDATE_UserPersonEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[UPDATE_UserPerson400ResponseBody]):
    ...
    body: UPDATE_UserPerson400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: UPDATE_UserPerson400ResponseBody):
      self.headers = UPDATE_UserPersonEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def UPDATE_UserPerson(self, req: Request) -> Response: pass
