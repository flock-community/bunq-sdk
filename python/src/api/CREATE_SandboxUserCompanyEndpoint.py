...
class CREATE_SandboxUserCompanyEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[SandboxUserCompany]):
    ...
    def __init__(self, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str, body: SandboxUserCompany):
      self.path = CREATE_SandboxUserCompanyEndpoint.Request.Path()
      self.queries = CREATE_SandboxUserCompanyEndpoint.Request.Queries()
      self.headers = CREATE_SandboxUserCompanyEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[SandboxUserCompanyCreate]):
    ...
    body: SandboxUserCompanyCreate = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: SandboxUserCompanyCreate):
      self.headers = CREATE_SandboxUserCompanyEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[CREATE_SandboxUserCompany400ResponseBody]):
    ...
    body: CREATE_SandboxUserCompany400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: CREATE_SandboxUserCompany400ResponseBody):
      self.headers = CREATE_SandboxUserCompanyEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def CREATE_SandboxUserCompany(self, req: Request) -> Response: pass
