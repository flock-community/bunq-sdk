...
class READ_MonetaryAccountSavings_for_UserEndpoint (Wirespec.Endpoint):
  ...
  class Request(Wirespec.Request[None]):
    ...
    def __init__(self, userID: int, itemId: int, CacheControl: Optional[str], UserAgent: str, XBunqLanguage: Optional[str], XBunqRegion: Optional[str], XBunqClientRequestId: Optional[str], XBunqGeolocation: Optional[str], XBunqClientAuthentication: str):
      self.path = READ_MonetaryAccountSavings_for_UserEndpoint.Request.Path(userID = userID, itemId = itemId)
      self.queries = READ_MonetaryAccountSavings_for_UserEndpoint.Request.Queries()
      self.headers = READ_MonetaryAccountSavings_for_UserEndpoint.Request.Headers(  CacheControl = CacheControl,
        UserAgent = UserAgent,
  ...
  class Response200(Wirespec.Response[MonetaryAccountSavingsRead]):
    ...
    body: MonetaryAccountSavingsRead = None
    status: int = 200
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: MonetaryAccountSavingsRead):
      self.headers = READ_MonetaryAccountSavings_for_UserEndpoint.Response200.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
  ...
  class Response400(Wirespec.Response[READ_MonetaryAccountSavings_for_User400ResponseBody]):
    ...
    body: READ_MonetaryAccountSavings_for_User400ResponseBody = None
    status: int = 400
    headers: Headers = None
    ...
    def __init__(self, XBunqClientResponseId: Optional[str], XBunqClientRequestId: Optional[str], XBunqServerSignature: Optional[str], body: READ_MonetaryAccountSavings_for_User400ResponseBody):
      self.headers = READ_MonetaryAccountSavings_for_UserEndpoint.Response400.Headers(  XBunqClientResponseId = XBunqClientResponseId,
        XBunqClientRequestId = XBunqClientRequestId,
        XBunqServerSignature = XBunqServerSignature)
      self.body = body
  ...
  @abstractmethod
  def READ_MonetaryAccountSavings_for_User(self, req: Request) -> Response: pass
