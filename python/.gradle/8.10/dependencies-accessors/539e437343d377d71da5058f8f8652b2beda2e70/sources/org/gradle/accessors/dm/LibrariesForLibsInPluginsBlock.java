...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final WirespecLibraryAccessors laccForWirespecLibraryAccessors = new WirespecLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>wirespec</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public WirespecLibraryAccessors getWirespec() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForWirespecLibraryAccessors;
    }
    ...
    public static class KtorLibraryAccessors extends SubDependencyFactory {
        ...
        private final KtorTestLibraryAccessors laccForKtorTestLibraryAccessors = new KtorTestLibraryAccessors(owner);

        public KtorLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>client</b> with <b>io.ktor:ktor-client-core</b> coordinates and
        ...
        /**
         * Group of libraries at <b>ktor.test</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public KtorTestLibraryAccessors getTest() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForKtorTestLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class KtorTestLibraryAccessors extends SubDependencyFactory {
        private final KtorTestServerLibraryAccessors laccForKtorTestServerLibraryAccessors = new KtorTestServerLibraryAccessors(owner);

        public KtorTestLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>ktor.test.server</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public KtorTestServerLibraryAccessors getServer() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForKtorTestServerLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class KtorTestServerLibraryAccessors extends SubDependencyFactory {
        private final KtorTestServerTestsLibraryAccessors laccForKtorTestServerTestsLibraryAccessors = new KtorTestServerTestsLibraryAccessors(owner);

        public KtorTestServerLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>ktor.test.server.tests</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public KtorTestServerTestsLibraryAccessors getTests() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForKtorTestServerTestsLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class KtorTestServerTestsLibraryAccessors extends SubDependencyFactory {

        public KtorTestServerTestsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>jvm</b> with <b>io.ktor:ktor-server-tests-jvm</b> coordinates and
         * with version reference <b>ktor</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getJvm() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("ktor.test.server.tests.jvm");
        }
     ...
     */
    @Deprecated
    public static class WirespecLibraryAccessors extends SubDependencyFactory {

        public WirespecLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>compiler</b> with <b>community.flock.wirespec.compiler:core-jvm</b> coordinates and
         * with version reference <b>wirespec</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getCompiler() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("wirespec.compiler");
        }

        /**
         * Dependency provider for <b>integration</b> with <b>community.flock.wirespec.integration:wirespec-jvm</b> coordinates and
         * with version reference <b>wirespec</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getIntegration() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("wirespec.integration");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>spotless</b> with value <b>7.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>wirespec</b> with value <b>0.0.0-SNAPSHOT</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getWirespec() { return getVersion("wirespec"); }
    ...
    public static class KotlinxVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>kotlinx.serialization</b> with value <b>1.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
     ...
     */
    @Deprecated
    public static class KtorBundleAccessors extends BundleFactory  implements BundleNotationSupplier{
         ...
         * <ul>
         *    <li>io.ktor:ktor-server-core-jvm</li>
         *    <li>io.ktor:ktor-server-netty-jvm</li>
        ...
        /**
         * Dependency bundle provider for <b>ktor.test</b> which contains the following dependencies:
         * <ul>
         *    <li>io.ktor:ktor-server-tests-jvm</li>
         * </ul>
         * <p>
         * This bundle was declared in catalog libs.versions.toml
         *
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>wirespec</b> with plugin id <b>community.flock.wirespec.plugin.gradle</b> and
         * with version reference <b>wirespec</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getWirespec() { return createPlugin("wirespec"); }
