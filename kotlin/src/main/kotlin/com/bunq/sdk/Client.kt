...
class Client(private val signing: Signing, private val context: Context): List_all_MonetaryAccountBank_for_User.Handler, READ_User.Handler {
    override suspend fun list_all_MonetaryAccountBank_for_User(request: List_all_MonetaryAccountBank_for_User.Request): List_all_MonetaryAccountBank_for_User.Response<*> = handle(signing, context, request)
    override suspend fun rEAD_User(request: READ_User.Request): READ_User.Response<*> = handle(signing, context, request)
}
