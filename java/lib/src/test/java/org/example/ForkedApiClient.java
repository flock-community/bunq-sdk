...
public class ForkedApiClient {
     ...
     */
    public ForkedApiClient(ApiContext apiContext) {
    ...
    public BunqResponseRaw post(
        ...
        if (customHeaders.containsKey(com.bunq.sdk.http.BunqHeader.CONTENT_TYPE.getHeaderName())) {
            bunqRequestBody = BunqRequestBody.create(
                    MediaType.parse(customHeaders.get(com.bunq.sdk.http.BunqHeader.CONTENT_TYPE.getHeaderName())),
                    requestBodyBytes
            );
        }
...
//        setSessionHeaders(requestBuilder);
    ...
    private void setDefaultHeaders(BunqRequestBuilder httpEntity) {
        com.bunq.sdk.http.BunqHeader.CACHE_CONTROL.addTo(httpEntity);
        com.bunq.sdk.http.BunqHeader.USER_AGENT.addTo(httpEntity);
        com.bunq.sdk.http.BunqHeader.LANGUAGE.addTo(httpEntity);
        com.bunq.sdk.http.BunqHeader.REGION.addTo(httpEntity);
        com.bunq.sdk.http.BunqHeader.CLIENT_REQUEST_ID.addTo(httpEntity, UUID.randomUUID().toString());
        com.bunq.sdk.http.BunqHeader.GEOLOCATION.addTo(httpEntity);
    }
    ...
    private void setSessionHeaders(BunqRequestBuilder requestBuilder) {
        ...
        if (sessionToken != null) {
            com.bunq.sdk.http.BunqHeader.CLIENT_AUTHENTICATION.addTo(requestBuilder, sessionToken);
            com.bunq.sdk.http.BunqHeader.CLIENT_SIGNATURE.addTo(requestBuilder, generateSignature(requestBuilder));
        }
    }
